...
/** \brief A unit heater serving a thermal zone.
 *
 * \par EnergyPlus object
 * \epobject{group-zone-forced-air-units.html#zonehvacunitheater,ZoneHVAC:UnitHeater}
 *
 * \par Important behavior
 * The fan and heating coil share a parent-owned air path; fanOutletNode() exposes its meaningful internal role.
 *
 * \par OpenStudio Model API
 * The corresponding OpenStudio Model class is <code>openstudio::model::ZoneHVACUnitHeater</code>.
 *
 * \par Known limitations
 * Less common child-equipment combinations and remaining Model relationship conveniences are not comprehensively covered.
 */
