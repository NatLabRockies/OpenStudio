...
namespace epmodel {
  namespace detail {
    ...
    Schedule ZoneHVACCoolingPanelRadiantConvectiveWater_Impl::availabilitySchedule() const {
      ...
      LOG_FREE_AND_THROW("openstudio.epmodel.ZoneHVACCoolingPanelRadiantConvectiveWater", briefDescription()
    ...
    HVACComponent ZoneHVACCoolingPanelRadiantConvectiveWater_Impl::coolingCoil() const {
      ...
      return model()
        .getOrCreateTransientByName<openstudio::epmodel::CoilCoolingWaterPanelRadiant>(detail::transientCoolingCoilName(parent))
        .cast<HVACComponent>();
    }
    ...
    bool ZoneHVACCoolingPanelRadiantConvectiveWater_Impl::setCoolingCoil(HVACComponent& coolingCoil) {
      ...
      result = source->isMaximumChilledWaterFlowRateAutosized()
                 ? (target.autosizeMaximumChilledWaterFlowRate(), result)
                 : (source->maximumChilledWaterFlowRate() ? (target.setMaximumChilledWaterFlowRate(*source->maximumChilledWaterFlowRate()) && result)
