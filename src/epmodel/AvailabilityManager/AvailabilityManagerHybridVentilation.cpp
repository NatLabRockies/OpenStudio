...
AvailabilityManagerHybridVentilation::AvailabilityManagerHybridVentilation(
  std::shared_ptr<detail::AvailabilityManagerHybridVentilation_Impl> impl)
...
bool AvailabilityManagerHybridVentilation_Impl::setMinimumOutdoorTemperature(double minimumOutdoorTemperature) {
  const bool result =
    setDouble(openstudio::AvailabilityManager_HybridVentilationFields::MinimumOutdoorTemperature, minimumOutdoorTemperature);
  OS_ASSERT(result);
  return result;
}
...
bool AvailabilityManagerHybridVentilation_Impl::setMaximumOutdoorTemperature(double maximumOutdoorTemperature) {
  const bool result =
    setDouble(openstudio::AvailabilityManager_HybridVentilationFields::MaximumOutdoorTemperature, maximumOutdoorTemperature);
  OS_ASSERT(result);
  return result;
}
...
bool AvailabilityManagerHybridVentilation_Impl::setMinimumHVACOperationTime(double minimumHVACOperationTime) {
  const bool result =
    setDouble(openstudio::AvailabilityManager_HybridVentilationFields::MinimumHVACOperationTime, minimumHVACOperationTime);
  OS_ASSERT(result);
  return result;
}
...
bool AvailabilityManagerHybridVentilation_Impl::setMinimumVentilationTime(double minimumVentilationTime) {
  const bool result =
    setDouble(openstudio::AvailabilityManager_HybridVentilationFields::MinimumVentilationTime, minimumVentilationTime);
  OS_ASSERT(result);
  return result;
}
