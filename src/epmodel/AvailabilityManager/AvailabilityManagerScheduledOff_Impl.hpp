...
#ifndef EPMODEL_AVAILABILITYMANAGERSCHEDULEDOFF_IMPL_HPP
#define EPMODEL_AVAILABILITYMANAGERSCHEDULEDOFF_IMPL_HPP
...
class EPMODEL_API AvailabilityManagerScheduledOff_Impl : public AvailabilityManager_Impl
{
 public:
