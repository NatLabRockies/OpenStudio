...
namespace epmodel {
  namespace detail {
    ...
    bool AvailabilityManagerDifferentialThermostat_Impl::setTemperatureDifferenceOnLimit(double temperatureDifferenceOnLimit) {
      const bool result =
        setDouble(openstudio::AvailabilityManager_DifferentialThermostatFields::TemperatureDifferenceOnLimit, temperatureDifferenceOnLimit);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool AvailabilityManagerDifferentialThermostat_Impl::setTemperatureDifferenceOffLimit(double temperatureDifferenceOffLimit) {
      const bool result =
        setDouble(openstudio::AvailabilityManager_DifferentialThermostatFields::TemperatureDifferenceOffLimit, temperatureDifferenceOffLimit);
      OS_ASSERT(result);
      return result;
    }
