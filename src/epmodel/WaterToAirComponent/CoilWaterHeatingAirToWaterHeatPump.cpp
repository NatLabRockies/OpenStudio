...
namespace epmodel {
  ...
  CoilWaterHeatingAirToWaterHeatPump::CoilWaterHeatingAirToWaterHeatPump(const Model& model, const Curve& heatingCapacityFunctionofTemperatureCurve,
  ...
  bool
    CoilWaterHeatingAirToWaterHeatPump::setHeatingCapacityFunctionofAirFlowFractionCurve(const Curve& heatingCapacityFunctionofAirFlowFractionCurve) {
  ...
  bool CoilWaterHeatingAirToWaterHeatPump::setHeatingCOPFunctionofTemperatureCurve(const Curve& heatingCOPFunctionofTemperatureCurve) {
    return getImpl<detail::CoilWaterHeatingAirToWaterHeatPump_Impl>()->setHeatingCOPFunctionofTemperatureCurve(heatingCOPFunctionofTemperatureCurve);
  }
  ...
  bool CoilWaterHeatingAirToWaterHeatPump::setHeatingCOPFunctionofAirFlowFractionCurve(const Curve& heatingCOPFunctionofAirFlowFractionCurve) {
  ...
  bool CoilWaterHeatingAirToWaterHeatPump::setHeatingCOPFunctionofWaterFlowFractionCurve(const Curve& heatingCOPFunctionofWaterFlowFractionCurve) {
  ...
  bool CoilWaterHeatingAirToWaterHeatPump::setPartLoadFractionCorrelationCurve(const Curve& partLoadFractionCorrelationCurve) {
    return getImpl<detail::CoilWaterHeatingAirToWaterHeatPump_Impl>()->setPartLoadFractionCorrelationCurve(partLoadFractionCorrelationCurve);
  }
...
namespace epmodel {
  namespace detail {
    ...
    bool CoilWaterHeatingAirToWaterHeatPump_Impl::setCondenserPumpHeatIncludedinRatedHeatingCapacityandRatedCOP(
      bool condenserPumpHeatIncludedinRatedHeatingCapacityandRatedCOP) {
      const bool result =
        setString(openstudio::Coil_WaterHeating_AirToWaterHeatPump_PumpedFields::CondenserPumpHeatIncludedinRatedHeatingCapacityandRatedCOP,
    ...
    std::string CoilWaterHeatingAirToWaterHeatPump_Impl::evaporatorAirTemperatureTypeforCurveObjects() const {
      const auto value = getString(openstudio::Coil_WaterHeating_AirToWaterHeatPump_PumpedFields::EvaporatorAirTemperatureTypeforCurveObjects, true);
      OS_ASSERT(value);
      return *value;
    }
    ...
    bool
      CoilWaterHeatingAirToWaterHeatPump_Impl::setHeatingCapacityFunctionofTemperatureCurve(const Curve& heatingCapacityFunctionofTemperatureCurve) {
    ...
    bool CoilWaterHeatingAirToWaterHeatPump_Impl::setHeatingCOPFunctionofAirFlowFractionCurve(const Curve& heatingCOPFunctionofAirFlowFractionCurve) {
