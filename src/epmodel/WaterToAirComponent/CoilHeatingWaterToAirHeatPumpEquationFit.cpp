...
namespace epmodel {
  ...
  AirflowNetworkDistributionComponentCoil CoilHeatingWaterToAirHeatPumpEquationFit::getAirflowNetworkEquivalentDuct(double length, double diameter) {
...
namespace epmodel {
  namespace detail {
    ...
    bool CoilHeatingWaterToAirHeatPumpEquationFit_Impl::setRatedHeatingCoefficientofPerformance(double ratedHeatingCoefficientofPerformance) {
      return setDouble(openstudio::Coil_Heating_WaterToAirHeatPump_EquationFitFields::GrossRatedHeatingCOP, ratedHeatingCoefficientofPerformance);
    }
