...
namespace epmodel {
  ...
  class EPMODEL_API CoilHeatingWaterToAirHeatPumpEquationFit : public WaterToAirComponent
  {
   public:
    ...
    //   through the stored curves, the scalar fit fields, the constructor's autosized rating fields and 3.0 COP default,
    //   and the autosized-value query helpers preserve the canonical public contract.
