...
namespace epmodel {
  ...
  namespace {
    ...
    boost::optional<EnergyManagementSystemActuator> resolveActuatorForRole(const CoilUserDefined& coil, const std::string_view componentType,
                                                                           const std::string_view controlType, const std::string_view defaultName,
  ...
  CoilUserDefined::CoilUserDefined(const Model& model) : WaterToAirComponent(CoilUserDefined::iddObjectType(), model) {
    ...
    EnergyManagementSystemActuator airOutletHumidityRatio(*this, std::string(kAirConnectionType), std::string(kAirOutletHumidityRatioControlType));
    ...
    EnergyManagementSystemActuator plantOutletTemperature(*this, std::string(kPlantConnectionType), std::string(kPlantOutletTemperatureControlType));
...
namespace epmodel {
  namespace detail {
    ...
    EnergyManagementSystemActuator CoilUserDefined_Impl::airOutletTemperatureActuator() const {
      if (auto actuator =
            resolveActuatorForRole(getObject<openstudio::epmodel::CoilUserDefined>(), kAirConnectionType, kAirOutletTemperatureControlType,
                                   kAirOutletTemperatureDefaultName, kAirOutletTemperatureActuatorChildSuffix)) {
        return *actuator;
      }
    ...
    bool CoilUserDefined_Impl::setAirOutletTemperatureActuator(const EnergyManagementSystemActuator& emsActuator) {
      return bindActuatorRole(getObject<openstudio::epmodel::CoilUserDefined>(), emsActuator, kAirConnectionType, kAirOutletTemperatureControlType);
    }

    EnergyManagementSystemActuator CoilUserDefined_Impl::airOutletHumidityRatioActuator() const {
      if (auto actuator =
            resolveActuatorForRole(getObject<openstudio::epmodel::CoilUserDefined>(), kAirConnectionType, kAirOutletHumidityRatioControlType,
                                   kAirOutletHumidityRatioDefaultName, kAirOutletHumidityRatioActuatorChildSuffix)) {
        return *actuator;
      }
    ...
    bool CoilUserDefined_Impl::setAirOutletHumidityRatioActuator(const EnergyManagementSystemActuator& emsActuator) {
      return bindActuatorRole(getObject<openstudio::epmodel::CoilUserDefined>(), emsActuator, kAirConnectionType, kAirOutletHumidityRatioControlType);
    }

    EnergyManagementSystemActuator CoilUserDefined_Impl::airMassFlowRateActuator() const {
      if (auto actuator = resolveActuatorForRole(getObject<openstudio::epmodel::CoilUserDefined>(), kAirConnectionType, kAirMassFlowRateControlType,
                                                 kAirMassFlowRateDefaultName, kAirMassFlowRateActuatorChildSuffix)) {
        return *actuator;
      }
    ...
    bool CoilUserDefined_Impl::setAirMassFlowRateActuator(const EnergyManagementSystemActuator& emsActuator) {
      return bindActuatorRole(getObject<openstudio::epmodel::CoilUserDefined>(), emsActuator, kAirConnectionType, kAirMassFlowRateControlType);
    }

    EnergyManagementSystemActuator CoilUserDefined_Impl::plantMinimumMassFlowRateActuator() const {
      if (auto actuator =
            resolveActuatorForRole(getObject<openstudio::epmodel::CoilUserDefined>(), kPlantConnectionType, kPlantMinimumMassFlowRateControlType,
                                   kPlantMinimumMassFlowRateDefaultName, kPlantMinimumMassFlowRateActuatorChildSuffix)) {
        return *actuator;
      }
    ...
    EnergyManagementSystemActuator CoilUserDefined_Impl::plantMaximumMassFlowRateActuator() const {
      if (auto actuator =
            resolveActuatorForRole(getObject<openstudio::epmodel::CoilUserDefined>(), kPlantConnectionType, kPlantMaximumMassFlowRateControlType,
                                   kPlantMaximumMassFlowRateDefaultName, kPlantMaximumMassFlowRateActuatorChildSuffix)) {
        return *actuator;
      }
    ...
    EnergyManagementSystemActuator CoilUserDefined_Impl::plantDesignVolumeFlowRateActuator() const {
      if (auto actuator =
            resolveActuatorForRole(getObject<openstudio::epmodel::CoilUserDefined>(), kPlantConnectionType, kPlantDesignVolumeFlowRateControlType,
                                   kPlantDesignVolumeFlowRateDefaultName, kPlantDesignVolumeFlowRateActuatorChildSuffix)) {
        return *actuator;
      }
    ...
    EnergyManagementSystemActuator CoilUserDefined_Impl::plantOutletTemperatureActuator() const {
      if (auto actuator =
            resolveActuatorForRole(getObject<openstudio::epmodel::CoilUserDefined>(), kPlantConnectionType, kPlantOutletTemperatureControlType,
                                   kPlantOutletTemperatureDefaultName, kPlantOutletTemperatureActuatorChildSuffix)) {
        return *actuator;
      }
    ...
    EnergyManagementSystemActuator CoilUserDefined_Impl::plantMassFlowRateActuator() const {
      if (auto actuator =
            resolveActuatorForRole(getObject<openstudio::epmodel::CoilUserDefined>(), kPlantConnectionType, kPlantMassFlowRateControlType,
                                   kPlantMassFlowRateDefaultName, kPlantMassFlowRateActuatorChildSuffix)) {
        return *actuator;
      }
    ...
    bool CoilUserDefined_Impl::setPlantMassFlowRateActuator(const EnergyManagementSystemActuator& emsActuator) {
      return bindActuatorRole(getObject<openstudio::epmodel::CoilUserDefined>(), emsActuator, kPlantConnectionType, kPlantMassFlowRateControlType);
    }
