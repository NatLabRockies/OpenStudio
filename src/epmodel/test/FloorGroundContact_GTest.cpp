...
#include "../ModelObject/FloorGroundContact.hpp"

using namespace openstudio::epmodel;

TEST_F(EPModelFixture, FloorGroundContact_DefaultConstructor) {
  Model model;
  FloorGroundContact floor(model);
  EXPECT_EQ(FloorGroundContact::iddObjectType(), floor.iddObject().type());
...
TEST_F(EPModelFixture, FloorGroundContact_ScalarAccessors_RoundTrip) {
  Model model;
  FloorGroundContact floor(model);
