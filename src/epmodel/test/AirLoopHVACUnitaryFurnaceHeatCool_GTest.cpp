...
#include "../ModelObject/AirLoopHVACUnitaryFurnaceHeatCool.hpp"

using namespace openstudio::epmodel;

TEST_F(EPModelFixture, AirLoopHVACUnitaryFurnaceHeatCool_DefaultConstructor) {
  Model model;
  AirLoopHVACUnitaryFurnaceHeatCool unitary(model);
  EXPECT_EQ(AirLoopHVACUnitaryFurnaceHeatCool::iddObjectType(), unitary.iddObject().type());
}

TEST_F(EPModelFixture, AirLoopHVACUnitaryFurnaceHeatCool_ScalarAccessors_RoundTrip) {
  Model model;
  AirLoopHVACUnitaryFurnaceHeatCool unitary(model);
