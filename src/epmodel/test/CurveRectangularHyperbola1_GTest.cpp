...
TEST_F(EPModelFixture, CurveRectangularHyperbola1_DefaultConstructor) {
  Model model;
  CurveRectangularHyperbola1 curve(model);
  EXPECT_EQ(CurveRectangularHyperbola1::iddObjectType(), curve.iddObject().type());
...
TEST_F(EPModelFixture, CurveRectangularHyperbola1_ScalarAccessors_RoundTrip) {
  Model model;
  CurveRectangularHyperbola1 curve(model);
  ...
  const auto xValues = CurveRectangularHyperbola1::validInputUnitTypeforxValues();
  ...
  const auto outputValues = CurveRectangularHyperbola1::validOutputUnitTypeValues();
