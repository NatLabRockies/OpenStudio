...
#include "../ModelObject/DemandManagerElectricEquipment.hpp"

using namespace openstudio::epmodel;

TEST_F(EPModelFixture, DemandManagerElectricEquipment_DefaultConstructor) {
  Model model;
  DemandManagerElectricEquipment object(model);
  EXPECT_EQ(DemandManagerElectricEquipment::iddObjectType(), object.iddObject().type());
}

TEST_F(EPModelFixture, DemandManagerElectricEquipment_ScalarAccessors_RoundTrip) {
  Model model;
  DemandManagerElectricEquipment object(model);
