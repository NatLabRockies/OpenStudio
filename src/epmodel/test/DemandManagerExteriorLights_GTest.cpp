...
#include "../ModelObject/DemandManagerExteriorLights.hpp"

using namespace openstudio::epmodel;

TEST_F(EPModelFixture, DemandManagerExteriorLights_DefaultConstructor) {
  Model model;
  DemandManagerExteriorLights object(model);
  EXPECT_EQ(DemandManagerExteriorLights::iddObjectType(), object.iddObject().type());
}

TEST_F(EPModelFixture, DemandManagerExteriorLights_ScalarAccessors_RoundTrip) {
  Model model;
  DemandManagerExteriorLights object(model);
