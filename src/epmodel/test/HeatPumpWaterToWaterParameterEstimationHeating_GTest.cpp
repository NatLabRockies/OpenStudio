...
#include "../ModelObject/HeatPumpWaterToWaterParameterEstimationHeating.hpp"

using namespace openstudio::epmodel;

TEST_F(EPModelFixture, HeatPumpWaterToWaterParameterEstimationHeating_DefaultConstructor) {
  Model model;
  HeatPumpWaterToWaterParameterEstimationHeating hp(model);

  EXPECT_EQ(HeatPumpWaterToWaterParameterEstimationHeating::iddObjectType(), hp.iddObject().type());
...
TEST_F(EPModelFixture, HeatPumpWaterToWaterParameterEstimationHeating_ScalarAccessors_RoundTrip) {
  Model model;
  HeatPumpWaterToWaterParameterEstimationHeating hp(model);
