...
TEST_F(EPModelFixture, ZoneHVACBaseboardRadiantConvectiveWaterDesign_DefaultConstructor) {
  Model model;
  ZoneHVACBaseboardRadiantConvectiveWaterDesign baseboard(model);

  EXPECT_EQ(ZoneHVACBaseboardRadiantConvectiveWaterDesign::iddObjectType(), baseboard.iddObject().type());
...
TEST_F(EPModelFixture, ZoneHVACBaseboardRadiantConvectiveWaterDesign_ScalarAccessors_RoundTrip) {
  Model model;
  ZoneHVACBaseboardRadiantConvectiveWaterDesign baseboard(model);
