...
#include "../ModelObject/AirLoopHVACUnitaryFurnaceHeatOnly.hpp"

using namespace openstudio::epmodel;

TEST_F(EPModelFixture, AirLoopHVACUnitaryFurnaceHeatOnly_DefaultConstructor) {
  Model model;
  AirLoopHVACUnitaryFurnaceHeatOnly unitary(model);
  EXPECT_EQ(AirLoopHVACUnitaryFurnaceHeatOnly::iddObjectType(), unitary.iddObject().type());
}

TEST_F(EPModelFixture, AirLoopHVACUnitaryFurnaceHeatOnly_ScalarAccessors_RoundTrip) {
  Model model;
  AirLoopHVACUnitaryFurnaceHeatOnly unitary(model);
