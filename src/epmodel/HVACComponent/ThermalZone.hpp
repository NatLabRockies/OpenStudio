...
namespace epmodel {
  ...
  class EPMODEL_API ThermalZone : public ModelObject
  {
   public:
    ...
    // - Implemented Parity: `addToNode`, shared and dual-duct lane-specific supply-plenum assignment/removal, shared return-plenum assignment/removal,
    //   scalar zone fields, `useIdealAirLoads`, thermostat convenience,
