...
EPMODELOBJECT_FORWARD_DECLARE(AirLoopHVACExhaustSystem)
...
EPMODELOBJECT_FORWARD_DECLARE(AirLoopHVACUnitaryHeatCool)
...
EPMODELOBJECT_FORWARD_DECLARE(ScheduleBase)
...
EPMODELOBJECT_FORWARD_DECLARE(ZoneHVACExhaustControl)
