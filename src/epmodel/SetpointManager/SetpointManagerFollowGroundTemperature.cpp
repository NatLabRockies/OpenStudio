...
namespace epmodel {
  namespace detail {
    ...
    bool SetpointManagerFollowGroundTemperature_Impl::setOffsetTemperatureDifference(double offsetTemperatureDifference) {
      const bool result =
        setDouble(openstudio::SetpointManager_FollowGroundTemperatureFields::OffsetTemperatureDifference, offsetTemperatureDifference);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool SetpointManagerFollowGroundTemperature_Impl::setMaximumSetpointTemperature(double maximumSetpointTemperature) {
      const bool result =
        setDouble(openstudio::SetpointManager_FollowGroundTemperatureFields::MaximumSetpointTemperature, maximumSetpointTemperature);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool SetpointManagerFollowGroundTemperature_Impl::setMinimumSetpointTemperature(double minimumSetpointTemperature) {
      const bool result =
        setDouble(openstudio::SetpointManager_FollowGroundTemperatureFields::MinimumSetpointTemperature, minimumSetpointTemperature);
      OS_ASSERT(result);
      return result;
    }
    ...
    void SetpointManagerFollowGroundTemperature_Impl::doCanonicalize(LoadContext& context) {
      ...
      if (auto value = getString(openstudio::SetpointManager_FollowGroundTemperatureFields::ReferenceGroundTemperatureObjectType, true)) {
        if (!value->empty()) {
          ...
          detail::addLoadInfo(context, "Set default Reference Ground Temperature Object Type to 'Site:GroundTemperature:BuildingSurface' for "
