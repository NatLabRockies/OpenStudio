...
namespace epmodel {
  ...
  bool SetpointManagerOutdoorAirReset::setSetpointatOutdoorHighTemperature(double setpointatOutdoorHighTemperature) {
    const bool result = getImpl<detail::SetpointManagerOutdoorAirReset_Impl>()->setSetpointatOutdoorHighTemperature(setpointatOutdoorHighTemperature);
    OS_ASSERT(result);
    return result;
  }
  ...
  bool SetpointManagerOutdoorAirReset::setSetpointatOutdoorLowTemperature2(double setpointatOutdoorLowTemperature2) {
    const bool result = getImpl<detail::SetpointManagerOutdoorAirReset_Impl>()->setSetpointatOutdoorLowTemperature2(setpointatOutdoorLowTemperature2);
    OS_ASSERT(result);
    return result;
  }
...
namespace epmodel {
  namespace detail {
    ...
    bool SetpointManagerOutdoorAirReset_Impl::setSetpointatOutdoorLowTemperature(double setpointatOutdoorLowTemperature) {
      const bool result =
        setDouble(openstudio::SetpointManager_OutdoorAirResetFields::SetpointatOutdoorLowTemperature, setpointatOutdoorLowTemperature);
      OS_ASSERT(result);
      return result;
    }
    ...
    boost::optional<openstudio::epmodel::Node> SetpointManagerOutdoorAirReset_Impl::setpointNode() const {
      return getObject<ModelObject>().getModelObjectTarget<openstudio::epmodel::Node>(
        openstudio::SetpointManager_OutdoorAirResetFields::SetpointNodeorNodeListName);
    }
    ...
    bool SetpointManagerOutdoorAirReset_Impl::setControlVariable(const std::string& value) {
      return setString(openstudio::SetpointManager_OutdoorAirResetFields::ControlVariable, value);
    }

    bool SetpointManagerOutdoorAirReset_Impl::setSetpointNode(const openstudio::epmodel::Node& node) {
      return getObject<ModelObject>().setPointer(openstudio::SetpointManager_OutdoorAirResetFields::SetpointNodeorNodeListName, node.handle());
    }

    void SetpointManagerOutdoorAirReset_Impl::doCanonicalize(LoadContext& context) {
      SetpointManager_Impl::doCanonicalize(context);
      canonicalizeSetpointNodeField(context, openstudio::SetpointManager_OutdoorAirResetFields::SetpointNodeorNodeListName);
