...
#ifndef EPMODEL_SETPOINTMANAGERSCHEDULEDDUALSETPOINT_IMPL_HPP
#define EPMODEL_SETPOINTMANAGERSCHEDULEDDUALSETPOINT_IMPL_HPP
...
class EPMODEL_API SetpointManagerScheduledDualSetpoint_Impl : public SetpointManager_Impl
{
 public:
