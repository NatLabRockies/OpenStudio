...
#ifndef EPMODEL_SETPOINTMANAGERMULTIZONEHEATINGAVERAGE_IMPL_HPP
#define EPMODEL_SETPOINTMANAGERMULTIZONEHEATINGAVERAGE_IMPL_HPP
...
namespace epmodel {
  namespace detail {
    ...
    class EPMODEL_API SetpointManagerMultiZoneHeatingAverage_Impl : public SetpointManager_Impl
    {
     public:
