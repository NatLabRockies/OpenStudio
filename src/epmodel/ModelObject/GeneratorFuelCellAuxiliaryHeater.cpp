...
bool GeneratorFuelCellAuxiliaryHeater_Impl::setAncillaryPowerConstantTerm(double ancillaryPowerConstantTerm) {
  const bool result =
    setDouble(openstudio::Generator_FuelCell_AuxiliaryHeaterFields::AncillaryPowerConstantTerm, ancillaryPowerConstantTerm);
  OS_ASSERT(result);
  return result;
}
...
bool GeneratorFuelCellAuxiliaryHeater_Impl::setMaximumHeatingCapacityinKmolperSecond(double maximumHeatingCapacityinKmolperSecond) {
  const bool result = setDouble(openstudio::Generator_FuelCell_AuxiliaryHeaterFields::MaximumHeatingCapacityinKmolperSecond,
...
bool GeneratorFuelCellAuxiliaryHeater_Impl::setMinimumHeatingCapacityinKmolperSecond(double minimumHeatingCapacityinKmolperSecond) {
  const bool result = setDouble(openstudio::Generator_FuelCell_AuxiliaryHeaterFields::MinimumHeatingCapacityinKmolperSecond,
