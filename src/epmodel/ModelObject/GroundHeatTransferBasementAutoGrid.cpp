...
bool GroundHeatTransferBasementAutoGrid::setConcAGHeightHeightofthefoundationwallabovegrade(
...
double GroundHeatTransferBasementAutoGrid_Impl::concAGHeightHeightofthefoundationwallabovegrade() const {
  const auto value =
    getDouble(openstudio::GroundHeatTransfer_Basement_AutoGridFields::ConcAGHeight_Heightofthefoundationwallabovegrade, true);
  OS_ASSERT(value);
  return *value;
}
