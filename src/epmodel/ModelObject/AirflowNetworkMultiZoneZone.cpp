...
AirflowNetworkMultiZoneZone::AirflowNetworkMultiZoneZone(const Model& model)
  : ModelObject(AirflowNetworkMultiZoneZone::iddObjectType(), model) {}
...
double AirflowNetworkMultiZoneZone_Impl::indoorandOutdoorTemperatureDifferenceLowerLimitForMaximumVentingOpenFactor() const {
  const auto value =
    getDouble(openstudio::AirflowNetwork_MultiZone_ZoneFields::IndoorandOutdoorTemperatureDifferenceLowerLimitForMaximumVentingOpenFactor,
              true);
  OS_ASSERT(value);
  return *value;
}
...
double AirflowNetworkMultiZoneZone_Impl::indoorandOutdoorTemperatureDifferenceUpperLimitforMinimumVentingOpenFactor() const {
  const auto value =
    getDouble(openstudio::AirflowNetwork_MultiZone_ZoneFields::IndoorandOutdoorTemperatureDifferenceUpperLimitforMinimumVentingOpenFactor,
              true);
  OS_ASSERT(value);
  return *value;
}
...
double AirflowNetworkMultiZoneZone_Impl::indoorandOutdoorEnthalpyDifferenceLowerLimitForMaximumVentingOpenFactor() const {
  const auto value =
    getDouble(openstudio::AirflowNetwork_MultiZone_ZoneFields::IndoorandOutdoorEnthalpyDifferenceLowerLimitForMaximumVentingOpenFactor,
              true);
  OS_ASSERT(value);
  return *value;
}
...
void AirflowNetworkMultiZoneZone_Impl::resetIndoorandOutdoorEnthalpyDifferenceLowerLimitForMaximumVentingOpenFactor() {
  OS_ASSERT(setString(openstudio::AirflowNetwork_MultiZone_ZoneFields::IndoorandOutdoorEnthalpyDifferenceLowerLimitForMaximumVentingOpenFactor,
                      ""));
}

double AirflowNetworkMultiZoneZone_Impl::indoorandOutdoorEnthalpyDifferenceUpperLimitforMinimumVentingOpenFactor() const {
  const auto value =
    getDouble(openstudio::AirflowNetwork_MultiZone_ZoneFields::IndoorandOutdoorEnthalpyDifferenceUpperLimitforMinimumVentingOpenFactor,
              true);
  OS_ASSERT(value);
  return *value;
}
...
void AirflowNetworkMultiZoneZone_Impl::resetIndoorandOutdoorEnthalpyDifferenceUpperLimitforMinimumVentingOpenFactor() {
  OS_ASSERT(setString(openstudio::AirflowNetwork_MultiZone_ZoneFields::IndoorandOutdoorEnthalpyDifferenceUpperLimitforMinimumVentingOpenFactor,
                      ""));
}
...
bool AirflowNetworkMultiZoneZone_Impl::setSingleSidedWindPressureCoefficientAlgorithm(const std::string& singleSidedWindPressureCoefficientAlgorithm) {
