...
std::vector<std::string> HVACTemplateZoneVRF::supplyAirFanplacementValues() {
  return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(),
                        openstudio::HVACTemplate_Zone_VRFFields::SupplyAirFanplacement);
}
...
std::vector<std::string> HVACTemplateZoneVRF::heatPumpHeatingCoilTypeValues() {
  return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(),
                        openstudio::HVACTemplate_Zone_VRFFields::HeatPumpHeatingCoilType);
}
...
VRF_SET_DOUBLE_CANFAIL(setZoneTerminalUnitOnParasiticElectricEnergyUse,
                       ZoneTerminalUnitOnParasiticElectricEnergyUse,
                       zoneTerminalUnitOnParasiticElectricEnergyUse)
VRF_SET_DOUBLE_CANFAIL(setZoneTerminalUnitOffParasiticElectricEnergyUse,
                       ZoneTerminalUnitOffParasiticElectricEnergyUse,
                       zoneTerminalUnitOffParasiticElectricEnergyUse)
VRF_SET_STRING(setZoneCoolingDesignSupplyAirTemperatureInputMethod,
...
VRF_SET_DOUBLE_ASSERT(setZoneCoolingDesignSupplyAirTemperatureDifference,
                      ZoneCoolingDesignSupplyAirTemperatureDifference,
                      zoneCoolingDesignSupplyAirTemperatureDifference)
VRF_SET_STRING(setZoneHeatingDesignSupplyAirTemperatureInputMethod,
...
VRF_SET_DOUBLE_ASSERT(setZoneHeatingDesignSupplyAirTemperatureDifference,
