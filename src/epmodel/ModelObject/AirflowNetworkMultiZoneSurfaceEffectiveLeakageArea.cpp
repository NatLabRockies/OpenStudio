...
namespace epmodel {
  namespace detail {
    ...
    double AirflowNetworkMultiZoneSurfaceEffectiveLeakageArea_Impl::effectiveLeakageArea() const {
      const auto value = getDouble(openstudio::AirflowNetwork_MultiZone_Surface_EffectiveLeakageAreaFields::EffectiveLeakageArea, true);
      OS_ASSERT(value);
      return *value;
    }
    ...
    double AirflowNetworkMultiZoneSurfaceEffectiveLeakageArea_Impl::dischargeCoefficient() const {
      const auto value = getDouble(openstudio::AirflowNetwork_MultiZone_Surface_EffectiveLeakageAreaFields::DischargeCoefficient, true);
      OS_ASSERT(value);
      return *value;
    }
    ...
    double AirflowNetworkMultiZoneSurfaceEffectiveLeakageArea_Impl::referencePressureDifference() const {
      const auto value = getDouble(openstudio::AirflowNetwork_MultiZone_Surface_EffectiveLeakageAreaFields::ReferencePressureDifference, true);
      OS_ASSERT(value);
      return *value;
    }
    ...
    bool AirflowNetworkMultiZoneSurfaceEffectiveLeakageArea_Impl::setReferencePressureDifference(double referencePressureDifference) {
      const bool result =
        setDouble(openstudio::AirflowNetwork_MultiZone_Surface_EffectiveLeakageAreaFields::ReferencePressureDifference, referencePressureDifference);
      OS_ASSERT(result);
      return result;
    }
    ...
    double AirflowNetworkMultiZoneSurfaceEffectiveLeakageArea_Impl::airMassFlowExponent() const {
      const auto value = getDouble(openstudio::AirflowNetwork_MultiZone_Surface_EffectiveLeakageAreaFields::AirMassFlowExponent, true);
      OS_ASSERT(value);
      return *value;
    }
