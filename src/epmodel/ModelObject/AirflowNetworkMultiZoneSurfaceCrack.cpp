...
AirflowNetworkMultiZoneSurfaceCrack::AirflowNetworkMultiZoneSurfaceCrack(
  std::shared_ptr<detail::AirflowNetworkMultiZoneSurfaceCrack_Impl> impl)
...
double AirflowNetworkMultiZoneSurfaceCrack_Impl::airMassFlowCoefficientatReferenceConditions() const {
  const auto value =
    getDouble(openstudio::AirflowNetwork_MultiZone_Surface_CrackFields::AirMassFlowCoefficientatReferenceConditions, true);
  OS_ASSERT(value);
  return *value;
}
