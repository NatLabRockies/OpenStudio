...
#ifndef EPMODEL_SURFACEPROPERTYCONVECTIONCOEFFICIENTS_IMPL_HPP
#define EPMODEL_SURFACEPROPERTYCONVECTIONCOEFFICIENTS_IMPL_HPP
...
namespace epmodel {
  ...
  namespace detail {
    ...
    class EPMODEL_API SurfacePropertyConvectionCoefficients_Impl : public ModelObject_Impl
    {
     public:
