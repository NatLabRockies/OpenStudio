...
bool AirflowNetworkDistributionComponentConstantPressureDrop::setPressureDifferenceAcrosstheComponent(
...
double AirflowNetworkDistributionComponentConstantPressureDrop_Impl::pressureDifferenceAcrosstheComponent() const {
  const auto value = getDouble(openstudio::AirflowNetwork_Distribution_Component_ConstantPressureDropFields::PressureDifferenceAcrosstheComponent, true);
  OS_ASSERT(value);
  return *value;
}
...
bool AirflowNetworkDistributionComponentConstantPressureDrop_Impl::setPressureDifferenceAcrosstheComponent(
  double pressureDifferenceAcrosstheComponent) {
  const bool result = setDouble(openstudio::AirflowNetwork_Distribution_Component_ConstantPressureDropFields::PressureDifferenceAcrosstheComponent,
                                pressureDifferenceAcrosstheComponent);
  OS_ASSERT(result);
  return result;
}
