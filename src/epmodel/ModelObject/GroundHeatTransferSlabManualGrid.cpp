...
bool GroundHeatTransferSlabManualGrid::setIBOXXdirectioncellindicatorofslabedge(int iBOXXdirectioncellindicatorofslabedge) {
  return getImpl<detail::GroundHeatTransferSlabManualGrid_Impl>()->setIBOXXdirectioncellindicatorofslabedge(
    iBOXXdirectioncellindicatorofslabedge);
}

bool GroundHeatTransferSlabManualGrid::setJBOXYdirectioncellindicatorofslabedge(int jBOXYdirectioncellindicatorofslabedge) {
  return getImpl<detail::GroundHeatTransferSlabManualGrid_Impl>()->setJBOXYdirectioncellindicatorofslabedge(
    jBOXYdirectioncellindicatorofslabedge);
}
...
bool GroundHeatTransferSlabManualGrid_Impl::setIBOXXdirectioncellindicatorofslabedge(int iBOXXdirectioncellindicatorofslabedge) {
  const bool result = setInt(openstudio::GroundHeatTransfer_Slab_ManualGridFields::IBOX_Xdirectioncellindicatorofslabedge,
                             iBOXXdirectioncellindicatorofslabedge);
  OS_ASSERT(result);
  return result;
}
...
bool GroundHeatTransferSlabManualGrid_Impl::setJBOXYdirectioncellindicatorofslabedge(int jBOXYdirectioncellindicatorofslabedge) {
  const bool result = setInt(openstudio::GroundHeatTransfer_Slab_ManualGridFields::JBOX_Ydirectioncellindicatorofslabedge,
                             jBOXYdirectioncellindicatorofslabedge);
  OS_ASSERT(result);
  return result;
}
