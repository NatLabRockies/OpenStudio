  ...
  namespace detail {
    ...
    boost::optional<double> SolarCollectorPerformancePhotovoltaicThermalSimple_Impl::thermalConversionEfficiency() const {
      ...
      if (istringEqual("Fixed", thermalConversionEfficiencyInputModeType())) {
        result = getDouble(openstudio::SolarCollectorPerformance_PhotovoltaicThermal_SimpleFields::ValueforThermalConversionEfficiencyifFixed, true);
        if (!result) {
          result = 0.3;
        }
      }
    ...
    bool SolarCollectorPerformancePhotovoltaicThermalSimple_Impl::setThermalConversionEfficiency(double valueforThermalConversionEfficiencyifFixed) {
      ...
      if (result) {
        ...
        result = setString(openstudio::SolarCollectorPerformance_PhotovoltaicThermal_SimpleFields::ThermalConversionEfficiencyInputModeType, "Fixed");
        OS_ASSERT(result);
