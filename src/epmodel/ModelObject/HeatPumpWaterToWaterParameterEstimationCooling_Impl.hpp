...
#ifndef EPMODEL_HEATPUMPWATERTOWATERPARAMETERESTIMATIONCOOLING_IMPL_HPP
#define EPMODEL_HEATPUMPWATERTOWATERPARAMETERESTIMATIONCOOLING_IMPL_HPP
...
class EPMODEL_API HeatPumpWaterToWaterParameterEstimationCooling_Impl : public ModelObject_Impl
{
 public:
  using ModelObject_Impl::ModelObject_Impl;
  virtual ~HeatPumpWaterToWaterParameterEstimationCooling_Impl() override = default;
