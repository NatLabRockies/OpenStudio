...
bool GeneratorCombustionTurbine_Impl::setMaximumExhaustFlowperUnitofPowerOutput(double maximumExhaustFlowperUnitofPowerOutput) {
  const bool result = setDouble(openstudio::Generator_CombustionTurbineFields::MaximumExhaustFlowperUnitofPowerOutput,
...
bool GeneratorCombustionTurbine_Impl::setDesignMinimumExhaustTemperature(double designMinimumExhaustTemperature) {
  const bool result =
    setDouble(openstudio::Generator_CombustionTurbineFields::DesignMinimumExhaustTemperature, designMinimumExhaustTemperature);
  OS_ASSERT(result);
  return result;
}
