...
bool ChillerCombustionTurbine::setCoefficient1ofTemperatureBasedFuelInputCurve(double coefficient1ofTemperatureBasedFuelInputCurve) {
  return getImpl<detail::ChillerCombustionTurbine_Impl>()->setCoefficient1ofTemperatureBasedFuelInputCurve(coefficient1ofTemperatureBasedFuelInputCurve);
}
...
bool ChillerCombustionTurbine::setCoefficient2ofTemperatureBasedFuelInputCurve(double coefficient2ofTemperatureBasedFuelInputCurve) {
  return getImpl<detail::ChillerCombustionTurbine_Impl>()->setCoefficient2ofTemperatureBasedFuelInputCurve(coefficient2ofTemperatureBasedFuelInputCurve);
}
...
bool ChillerCombustionTurbine::setCoefficient3ofTemperatureBasedFuelInputCurve(double coefficient3ofTemperatureBasedFuelInputCurve) {
  return getImpl<detail::ChillerCombustionTurbine_Impl>()->setCoefficient3ofTemperatureBasedFuelInputCurve(coefficient3ofTemperatureBasedFuelInputCurve);
}
...
bool ChillerCombustionTurbine::setCoefficient1ofTemperatureBasedExhaustGasTemperatureCurve(double coefficient1ofTemperatureBasedExhaustGasTemperatureCurve) {
  return getImpl<detail::ChillerCombustionTurbine_Impl>()->setCoefficient1ofTemperatureBasedExhaustGasTemperatureCurve(coefficient1ofTemperatureBasedExhaustGasTemperatureCurve);
}
...
bool ChillerCombustionTurbine::setCoefficient2ofTemperatureBasedExhaustGasTemperatureCurve(double coefficient2ofTemperatureBasedExhaustGasTemperatureCurve) {
  return getImpl<detail::ChillerCombustionTurbine_Impl>()->setCoefficient2ofTemperatureBasedExhaustGasTemperatureCurve(coefficient2ofTemperatureBasedExhaustGasTemperatureCurve);
}
...
bool ChillerCombustionTurbine::setCoefficient3ofTemperatureBasedExhaustGasTemperatureCurve(double coefficient3ofTemperatureBasedExhaustGasTemperatureCurve) {
  return getImpl<detail::ChillerCombustionTurbine_Impl>()->setCoefficient3ofTemperatureBasedExhaustGasTemperatureCurve(coefficient3ofTemperatureBasedExhaustGasTemperatureCurve);
}
...
bool ChillerCombustionTurbine::setCondenserHeatRecoveryRelativeCapacityFraction(double condenserHeatRecoveryRelativeCapacityFraction) {
  return getImpl<detail::ChillerCombustionTurbine_Impl>()->setCondenserHeatRecoveryRelativeCapacityFraction(condenserHeatRecoveryRelativeCapacityFraction);
}
...
bool ChillerCombustionTurbine_Impl::setDesignChilledWaterOutletTemperature(double designChilledWaterOutletTemperature) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::DesignChilledWaterOutletTemperature, designChilledWaterOutletTemperature);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setChilledWaterOutletTemperatureLowerLimit(double chilledWaterOutletTemperatureLowerLimit) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::ChilledWaterOutletTemperatureLowerLimit, chilledWaterOutletTemperatureLowerLimit);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient1ofTemperatureBasedFuelInputCurve(double coefficient1ofTemperatureBasedFuelInputCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient1ofTemperatureBasedFuelInputCurve, coefficient1ofTemperatureBasedFuelInputCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient2ofTemperatureBasedFuelInputCurve(double coefficient2ofTemperatureBasedFuelInputCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient2ofTemperatureBasedFuelInputCurve, coefficient2ofTemperatureBasedFuelInputCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient3ofTemperatureBasedFuelInputCurve(double coefficient3ofTemperatureBasedFuelInputCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient3ofTemperatureBasedFuelInputCurve, coefficient3ofTemperatureBasedFuelInputCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient1ofExhaustGasTemperatureCurve(double coefficient1ofExhaustGasTemperatureCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient1ofExhaustGasTemperatureCurve, coefficient1ofExhaustGasTemperatureCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient2ofExhaustGasTemperatureCurve(double coefficient2ofExhaustGasTemperatureCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient2ofExhaustGasTemperatureCurve, coefficient2ofExhaustGasTemperatureCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient3ofExhaustGasTemperatureCurve(double coefficient3ofExhaustGasTemperatureCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient3ofExhaustGasTemperatureCurve, coefficient3ofExhaustGasTemperatureCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient1ofTemperatureBasedExhaustGasTemperatureCurve(double coefficient1ofTemperatureBasedExhaustGasTemperatureCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient1ofTemperatureBasedExhaustGasTemperatureCurve, coefficient1ofTemperatureBasedExhaustGasTemperatureCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient2ofTemperatureBasedExhaustGasTemperatureCurve(double coefficient2ofTemperatureBasedExhaustGasTemperatureCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient2ofTemperatureBasedExhaustGasTemperatureCurve, coefficient2ofTemperatureBasedExhaustGasTemperatureCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient3ofTemperatureBasedExhaustGasTemperatureCurve(double coefficient3ofTemperatureBasedExhaustGasTemperatureCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient3ofTemperatureBasedExhaustGasTemperatureCurve, coefficient3ofTemperatureBasedExhaustGasTemperatureCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient1ofRecoveryLubeHeatCurve(double coefficient1ofRecoveryLubeHeatCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient1ofRecoveryLubeHeatCurve, coefficient1ofRecoveryLubeHeatCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient2ofRecoveryLubeHeatCurve(double coefficient2ofRecoveryLubeHeatCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient2ofRecoveryLubeHeatCurve, coefficient2ofRecoveryLubeHeatCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient3ofRecoveryLubeHeatCurve(double coefficient3ofRecoveryLubeHeatCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient3ofRecoveryLubeHeatCurve, coefficient3ofRecoveryLubeHeatCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient1ofUFactorTimesAreaCurve(double coefficient1ofUFactorTimesAreaCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient1ofUFactorTimesAreaCurve, coefficient1ofUFactorTimesAreaCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCoefficient2ofUFactorTimesAreaCurve(double coefficient2ofUFactorTimesAreaCurve) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::Coefficient2ofUFactorTimesAreaCurve, coefficient2ofUFactorTimesAreaCurve);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setMaximumExhaustFlowperUnitofPowerOutput(double maximumExhaustFlowperUnitofPowerOutput) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::MaximumExhaustFlowperUnitofPowerOutput, maximumExhaustFlowperUnitofPowerOutput);
  return result;
}
...
bool ChillerCombustionTurbine_Impl::setCondenserHeatRecoveryRelativeCapacityFraction(double condenserHeatRecoveryRelativeCapacityFraction) {
  const bool result = setDouble(openstudio::Chiller_CombustionTurbineFields::CondenserHeatRecoveryRelativeCapacityFraction, condenserHeatRecoveryRelativeCapacityFraction);
  return result;
}
