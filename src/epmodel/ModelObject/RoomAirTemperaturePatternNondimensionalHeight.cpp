...
bool RoomAirTemperaturePatternNondimensionalHeight::setControlIntegerforPatternControlScheduleName(
...
bool RoomAirTemperaturePatternNondimensionalHeight_Impl::setControlIntegerforPatternControlScheduleName(
  int controlIntegerforPatternControlScheduleName) {
  const bool result =
    setInt(openstudio::RoomAir_TemperaturePattern_NondimensionalHeightFields::ControlIntegerforPatternControlScheduleName,
           controlIntegerforPatternControlScheduleName);
  OS_ASSERT(result);
  return result;
}
