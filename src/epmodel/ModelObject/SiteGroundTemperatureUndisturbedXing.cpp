...
namespace epmodel {
  namespace detail {
    ...
    bool SiteGroundTemperatureUndisturbedXing_Impl::setSoilSurfaceTemperatureAmplitude1(double soilSurfaceTemperatureAmplitude1) {
      const bool result =
        setDouble(openstudio::Site_GroundTemperature_Undisturbed_XingFields::SoilSurfaceTemperatureAmplitude1, soilSurfaceTemperatureAmplitude1);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool SiteGroundTemperatureUndisturbedXing_Impl::setSoilSurfaceTemperatureAmplitude2(double soilSurfaceTemperatureAmplitude2) {
      const bool result =
        setDouble(openstudio::Site_GroundTemperature_Undisturbed_XingFields::SoilSurfaceTemperatureAmplitude2, soilSurfaceTemperatureAmplitude2);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool SiteGroundTemperatureUndisturbedXing_Impl::setPhaseShiftofTemperatureAmplitude1(double phaseShiftofTemperatureAmplitude1) {
      const bool result =
        setDouble(openstudio::Site_GroundTemperature_Undisturbed_XingFields::PhaseShiftofTemperatureAmplitude1, phaseShiftofTemperatureAmplitude1);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool SiteGroundTemperatureUndisturbedXing_Impl::setPhaseShiftofTemperatureAmplitude2(double phaseShiftofTemperatureAmplitude2) {
      const bool result =
        setDouble(openstudio::Site_GroundTemperature_Undisturbed_XingFields::PhaseShiftofTemperatureAmplitude2, phaseShiftofTemperatureAmplitude2);
      OS_ASSERT(result);
      return result;
    }
