...
bool SolarCollectorPerformanceIntegralCollectorStorage_Impl::setThermalMassOfAbsorberPlate(double thermalMassOfAbsorberPlate) {
  return setDouble(openstudio::SolarCollectorPerformance_IntegralCollectorStorageFields::ThermalMassofAbsorberPlate,
                   thermalMassOfAbsorberPlate);
}
...
void SolarCollectorPerformanceIntegralCollectorStorage_Impl::resetExtinctionCoefficientTimesThicknessOfTheInnerCover() {
  OS_ASSERT(setString(
    openstudio::SolarCollectorPerformance_IntegralCollectorStorageFields::ExtinctionCoefficientTimesThicknessoftheinnerCover, ""));
}
...
bool SolarCollectorPerformanceIntegralCollectorStorage_Impl::setAbsorptanceOfAbsorberPlate(double absorptanceOfAbsorberPlate) {
  return setDouble(openstudio::SolarCollectorPerformance_IntegralCollectorStorageFields::AbsorptanceofAbsorberPlate,
                   absorptanceOfAbsorberPlate);
}
...
bool SolarCollectorPerformanceIntegralCollectorStorage_Impl::setEmissivityOfAbsorberPlate(double emissivityOfAbsorberPlate) {
  return setDouble(openstudio::SolarCollectorPerformance_IntegralCollectorStorageFields::EmissivityofAbsorberPlate,
                   emissivityOfAbsorberPlate);
}
