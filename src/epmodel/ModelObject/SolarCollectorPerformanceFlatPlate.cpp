...
namespace epmodel {
  ...
  std::vector<std::string> SolarCollectorPerformanceFlatPlate::testFluidValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::SolarCollectorPerformance_FlatPlateFields::TestFluid);
  }
  ...
  namespace detail {
    ...
    bool SolarCollectorPerformanceFlatPlate_Impl::setCoefficient3ofEfficiencyEquation(boost::optional<double> coefficient3ofEfficiencyEquation) {
      ...
      if (coefficient3ofEfficiencyEquation) {
        result =
          setDouble(openstudio::SolarCollectorPerformance_FlatPlateFields::Coefficient3ofEfficiencyEquation, coefficient3ofEfficiencyEquation.get());
      } else {
