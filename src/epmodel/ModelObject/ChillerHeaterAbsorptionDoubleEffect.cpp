...
ChillerHeaterAbsorptionDoubleEffect::ChillerHeaterAbsorptionDoubleEffect(const Model& model) : ModelObject(ChillerHeaterAbsorptionDoubleEffect::iddObjectType(), model) {}

ChillerHeaterAbsorptionDoubleEffect::ChillerHeaterAbsorptionDoubleEffect(std::shared_ptr<detail::ChillerHeaterAbsorptionDoubleEffect_Impl> impl) : ModelObject(std::move(impl)) {}
...
std::vector<std::string> ChillerHeaterAbsorptionDoubleEffect::temperatureCurveInputVariableValues() {
  return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::ChillerHeater_Absorption_DoubleEffectFields::TemperatureCurveInputVariable);
}

std::vector<std::string> ChillerHeaterAbsorptionDoubleEffect::condenserTypeValues() {
  return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::ChillerHeater_Absorption_DoubleEffectFields::CondenserType);
}
...
bool ChillerHeaterAbsorptionDoubleEffect::setThermalEnergyInputtoCoolingOutputRatio(double thermalEnergyInputtoCoolingOutputRatio) {
  return getImpl<detail::ChillerHeaterAbsorptionDoubleEffect_Impl>()->setThermalEnergyInputtoCoolingOutputRatio(thermalEnergyInputtoCoolingOutputRatio);
}
...
bool ChillerHeaterAbsorptionDoubleEffect::setThermalEnergyInputtoHeatingOutputRatio(double thermalEnergyInputtoHeatingOutputRatio) {
  return getImpl<detail::ChillerHeaterAbsorptionDoubleEffect_Impl>()->setThermalEnergyInputtoHeatingOutputRatio(thermalEnergyInputtoHeatingOutputRatio);
}
...
bool ChillerHeaterAbsorptionDoubleEffect::setDesignEnteringCondenserWaterTemperature(double designEnteringCondenserWaterTemperature) {
  return getImpl<detail::ChillerHeaterAbsorptionDoubleEffect_Impl>()->setDesignEnteringCondenserWaterTemperature(designEnteringCondenserWaterTemperature);
}
...
bool ChillerHeaterAbsorptionDoubleEffect_Impl::setHeatingtoCoolingCapacityRatio(double heatingtoCoolingCapacityRatio) {
  const bool result = setDouble(openstudio::ChillerHeater_Absorption_DoubleEffectFields::HeatingtoCoolingCapacityRatio, heatingtoCoolingCapacityRatio);
  return result;
}
...
bool ChillerHeaterAbsorptionDoubleEffect_Impl::setThermalEnergyInputtoCoolingOutputRatio(double thermalEnergyInputtoCoolingOutputRatio) {
  const bool result = setDouble(openstudio::ChillerHeater_Absorption_DoubleEffectFields::ThermalEnergyInputtoCoolingOutputRatio, thermalEnergyInputtoCoolingOutputRatio);
  return result;
}
...
bool ChillerHeaterAbsorptionDoubleEffect_Impl::setThermalEnergyInputtoHeatingOutputRatio(double thermalEnergyInputtoHeatingOutputRatio) {
  const bool result = setDouble(openstudio::ChillerHeater_Absorption_DoubleEffectFields::ThermalEnergyInputtoHeatingOutputRatio, thermalEnergyInputtoHeatingOutputRatio);
  return result;
}
...
bool ChillerHeaterAbsorptionDoubleEffect_Impl::setElectricInputtoCoolingOutputRatio(double electricInputtoCoolingOutputRatio) {
  const bool result = setDouble(openstudio::ChillerHeater_Absorption_DoubleEffectFields::ElectricInputtoCoolingOutputRatio, electricInputtoCoolingOutputRatio);
  return result;
}
...
bool ChillerHeaterAbsorptionDoubleEffect_Impl::setElectricInputtoHeatingOutputRatio(double electricInputtoHeatingOutputRatio) {
  const bool result = setDouble(openstudio::ChillerHeater_Absorption_DoubleEffectFields::ElectricInputtoHeatingOutputRatio, electricInputtoHeatingOutputRatio);
  return result;
}
...
bool ChillerHeaterAbsorptionDoubleEffect_Impl::setDesignEnteringCondenserWaterTemperature(double designEnteringCondenserWaterTemperature) {
  const bool result = setDouble(openstudio::ChillerHeater_Absorption_DoubleEffectFields::DesignEnteringCondenserWaterTemperature, designEnteringCondenserWaterTemperature);
  OS_ASSERT(result);
  return result;
}
...
bool ChillerHeaterAbsorptionDoubleEffect_Impl::setDesignLeavingChilledWaterTemperature(double designLeavingChilledWaterTemperature) {
  const bool result = setDouble(openstudio::ChillerHeater_Absorption_DoubleEffectFields::DesignLeavingChilledWaterTemperature, designLeavingChilledWaterTemperature);
  OS_ASSERT(result);
  return result;
}
...
bool ChillerHeaterAbsorptionDoubleEffect_Impl::setDesignCondenserWaterFlowRate(double designCondenserWaterFlowRate) {
  const bool result = setDouble(openstudio::ChillerHeater_Absorption_DoubleEffectFields::DesignCondenserWaterFlowRate, designCondenserWaterFlowRate);
  OS_ASSERT(result);
  return result;
}
...
bool ChillerHeaterAbsorptionDoubleEffect_Impl::setTemperatureCurveInputVariable(const std::string& temperatureCurveInputVariable) {
  const bool result = setString(openstudio::ChillerHeater_Absorption_DoubleEffectFields::TemperatureCurveInputVariable, temperatureCurveInputVariable);
  return result;
}
...
bool ChillerHeaterAbsorptionDoubleEffect_Impl::setChilledWaterTemperatureLowerLimit(double chilledWaterTemperatureLowerLimit) {
  const bool result = setDouble(openstudio::ChillerHeater_Absorption_DoubleEffectFields::ChilledWaterTemperatureLowerLimit, chilledWaterTemperatureLowerLimit);
  OS_ASSERT(result);
  return result;
}
