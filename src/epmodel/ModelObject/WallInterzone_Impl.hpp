...
#ifndef EPMODEL_WALLINTERZONE_IMPL_HPP
#define EPMODEL_WALLINTERZONE_IMPL_HPP
...
namespace epmodel {
  ...
  namespace detail {
    ...
    class EPMODEL_API WallInterzone_Impl : public ModelObject_Impl
    {
     public:
      using ModelObject_Impl::ModelObject_Impl;
      virtual ~WallInterzone_Impl() override = default;
