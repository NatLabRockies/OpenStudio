...
bool GeneratorFuelCellPowerModule_Impl::setNumberofRunHoursatBeginningofSimulation(double numberofRunHoursatBeginningofSimulation) {
  const bool result = setDouble(openstudio::Generator_FuelCell_PowerModuleFields::NumberofRunHoursatBeginningofSimulation,
...
bool GeneratorFuelCellPowerModule_Impl::setShutDownElectricityConsumption(double shutDownElectricityConsumption) {
  const bool result =
    setDouble(openstudio::Generator_FuelCell_PowerModuleFields::ShutDownElectricityConsumption, shutDownElectricityConsumption);
  OS_ASSERT(result);
  return result;
}
...
bool GeneratorFuelCellPowerModule_Impl::setSkinLossUFactorTimesAreaTerm(double skinLossUFactorTimesAreaTerm) {
  const bool result =
    setDouble(openstudio::Generator_FuelCell_PowerModuleFields::SkinLossUFactorTimesAreaTerm, skinLossUFactorTimesAreaTerm);
  OS_ASSERT(result);
  return result;
}
...
bool GeneratorFuelCellPowerModule_Impl::setStackHeatlosstoDilutionAir(double stackHeatlosstoDilutionAir) {
  const bool result =
    setDouble(openstudio::Generator_FuelCell_PowerModuleFields::StackHeatlosstoDilutionAir, stackHeatlosstoDilutionAir);
  OS_ASSERT(result);
  return result;
}
