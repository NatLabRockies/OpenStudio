...
bool ChillerEngineDriven::setCondenserHeatRecoveryRelativeCapacityFraction(double condenserHeatRecoveryRelativeCapacityFraction) {
  return getImpl<detail::ChillerEngineDriven_Impl>()->setCondenserHeatRecoveryRelativeCapacityFraction(condenserHeatRecoveryRelativeCapacityFraction);
}
...
bool ChillerEngineDriven_Impl::setDesignChilledWaterOutletTemperature(double designChilledWaterOutletTemperature) {
  const bool result =
    setDouble(openstudio::Chiller_EngineDrivenFields::DesignChilledWaterOutletTemperature, designChilledWaterOutletTemperature);
  OS_ASSERT(result);
  return result;
}
