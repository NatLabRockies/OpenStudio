...
#ifndef EPMODEL_EXTERNALINTERFACEFUNCTIONALMOCKUPUNITIMPORTTOACTUATOR_IMPL_HPP
#define EPMODEL_EXTERNALINTERFACEFUNCTIONALMOCKUPUNITIMPORTTOACTUATOR_IMPL_HPP
...
class EPMODEL_API ExternalInterfaceFunctionalMockupUnitImportToActuator_Impl : public ModelObject_Impl
{
 public:
