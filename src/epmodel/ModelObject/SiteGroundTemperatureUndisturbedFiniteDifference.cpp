...
namespace epmodel {
  ...
  bool SiteGroundTemperatureUndisturbedFiniteDifference::setEvapotranspirationGroundCoverParameter(double evapotranspirationGroundCoverParameter) {
...
namespace epmodel {
  namespace detail {
    ...
    bool SiteGroundTemperatureUndisturbedFiniteDifference_Impl::setSoilThermalConductivity(double soilThermalConductivity) {
      const bool result =
        setDouble(openstudio::Site_GroundTemperature_Undisturbed_FiniteDifferenceFields::SoilThermalConductivity, soilThermalConductivity);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool SiteGroundTemperatureUndisturbedFiniteDifference_Impl::setSoilMoistureContentVolumeFractionatSaturation(
      double soilMoistureContentVolumeFractionatSaturation) {
      const bool result =
        setDouble(openstudio::Site_GroundTemperature_Undisturbed_FiniteDifferenceFields::SoilMoistureContentVolumeFractionatSaturation,
                  soilMoistureContentVolumeFractionatSaturation);
      OS_ASSERT(result);
      return result;
    }
