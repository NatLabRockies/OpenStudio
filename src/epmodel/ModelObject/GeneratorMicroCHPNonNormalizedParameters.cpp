...
bool GeneratorMicroCHPNonNormalizedParameters_Impl::setMaximumCoolingWaterTemperature(double maximumCoolingWaterTemperature) {
  const bool result = setDouble(openstudio::Generator_MicroCHP_NonNormalizedParametersFields::MaximumCoolingWaterTemperature,
                                maximumCoolingWaterTemperature);
  OS_ASSERT(result);
  return result;
}
...
bool GeneratorMicroCHPNonNormalizedParameters_Impl::setSkinLossUFactorTimesAreaValue(double skinLossUFactorTimesAreaValue) {
  const bool result = setDouble(openstudio::Generator_MicroCHP_NonNormalizedParametersFields::SkinLossUFactorTimesAreaValue,
...
boost::optional<double> GeneratorMicroCHPNonNormalizedParameters_Impl::aggregatedThermalMassofEnergyConversionPortionofGenerator() const {
  return getDouble(openstudio::Generator_MicroCHP_NonNormalizedParametersFields::AggregatedThermalMassofEnergyConversionPortionofGenerator,
                   true);
}
...
void GeneratorMicroCHPNonNormalizedParameters_Impl::resetAggregatedThermalMassofEnergyConversionPortionofGenerator() {
  OS_ASSERT(setString(openstudio::Generator_MicroCHP_NonNormalizedParametersFields::AggregatedThermalMassofEnergyConversionPortionofGenerator,
                      ""));
}
...
boost::optional<double> GeneratorMicroCHPNonNormalizedParameters_Impl::aggregatedThermalMassofHeatRecoveryPortionofGenerator() const {
  return getDouble(openstudio::Generator_MicroCHP_NonNormalizedParametersFields::AggregatedThermalMassofHeatRecoveryPortionofGenerator,
                   true);
}
...
bool GeneratorMicroCHPNonNormalizedParameters_Impl::setNominalEngineOperatingTemperature(double nominalEngineOperatingTemperature) {
  const bool result = setDouble(openstudio::Generator_MicroCHP_NonNormalizedParametersFields::NominalEngineOperatingTemperature,
                                nominalEngineOperatingTemperature);
  OS_ASSERT(result);
  return result;
}
