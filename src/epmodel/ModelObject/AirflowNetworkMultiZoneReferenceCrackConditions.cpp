...
bool AirflowNetworkMultiZoneReferenceCrackConditions::setReferenceBarometricPressure(double referenceBarometricPressure) {
  return getImpl<detail::AirflowNetworkMultiZoneReferenceCrackConditions_Impl>()->setReferenceBarometricPressure(
    referenceBarometricPressure);
}
...
bool AirflowNetworkMultiZoneReferenceCrackConditions_Impl::setReferenceTemperature(double referenceTemperature) {
  const bool result =
    setDouble(openstudio::AirflowNetwork_MultiZone_ReferenceCrackConditionsFields::ReferenceTemperature, referenceTemperature);
  OS_ASSERT(result);
  return result;
}
...
double AirflowNetworkMultiZoneReferenceCrackConditions_Impl::referenceBarometricPressure() const {
  const auto value =
    getDouble(openstudio::AirflowNetwork_MultiZone_ReferenceCrackConditionsFields::ReferenceBarometricPressure, true);
  OS_ASSERT(value);
  return *value;
}
...
bool AirflowNetworkMultiZoneReferenceCrackConditions_Impl::setReferenceBarometricPressure(double referenceBarometricPressure) {
  return setDouble(openstudio::AirflowNetwork_MultiZone_ReferenceCrackConditionsFields::ReferenceBarometricPressure,
                   referenceBarometricPressure);
}
