...
namespace epmodel {
  namespace detail {
    ...
    double AirflowNetworkMultiZoneComponentSimpleOpening_Impl::airMassFlowExponentWhenOpeningisClosed() const {
      const auto value = getDouble(openstudio::AirflowNetwork_MultiZone_Component_SimpleOpeningFields::AirMassFlowExponentWhenOpeningisClosed, true);
      OS_ASSERT(value);
      return *value;
    }
    ...
    bool
      AirflowNetworkMultiZoneComponentSimpleOpening_Impl::setAirMassFlowExponentWhenOpeningisClosed(double airMassFlowExponentWhenOpeningisClosed) {
    ...
    double AirflowNetworkMultiZoneComponentSimpleOpening_Impl::minimumDensityDifferenceforTwoWayFlow() const {
      const auto value = getDouble(openstudio::AirflowNetwork_MultiZone_Component_SimpleOpeningFields::MinimumDensityDifferenceforTwoWayFlow, true);
      OS_ASSERT(value);
      return *value;
    }
