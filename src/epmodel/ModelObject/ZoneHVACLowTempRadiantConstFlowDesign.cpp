  ...
  namespace detail {
    ...
    boost::optional<Schedule> ZoneHVACLowTempRadiantConstFlowDesign_Impl::changeoverDelayTimePeriodSchedule() const {
      return getObject<ModelObject>().getModelObjectTarget<Schedule>(
        openstudio::ZoneHVAC_LowTemperatureRadiant_ConstantFlow_DesignFields::ChangeoverDelayTimePeriodSchedule);
    }

    bool ZoneHVACLowTempRadiantConstFlowDesign_Impl::setChangeoverDelayTimePeriodSchedule(Schedule& schedule) {
      return setPointer(openstudio::ZoneHVAC_LowTemperatureRadiant_ConstantFlow_DesignFields::ChangeoverDelayTimePeriodSchedule, schedule.handle(),
                        false);
    }
    ...
    std::string ZoneHVACLowTempRadiantConstFlowDesign_Impl::fluidtoRadiantSurfaceHeatTransferModel() const {
      if (const auto value =
            getString(openstudio::ZoneHVAC_LowTemperatureRadiant_ConstantFlow_DesignFields::FluidtoRadiantSurfaceHeatTransferModel, true)) {
        return *value;
      }
    ...
    void ZoneHVACLowTempRadiantConstFlowDesign_Impl::resetRunningMeanOutdoorDryBulbTemperatureWeightingFactor() {
      OS_ASSERT(
        setString(openstudio::ZoneHVAC_LowTemperatureRadiant_ConstantFlow_DesignFields::RunningMeanOutdoorDryBulbTemperatureWeightingFactor, ""));
    }
