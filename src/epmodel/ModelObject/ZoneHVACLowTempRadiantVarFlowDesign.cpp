...
ZoneHVACLowTempRadiantVarFlowDesign::ZoneHVACLowTempRadiantVarFlowDesign(
  std::shared_ptr<detail::ZoneHVACLowTempRadiantVarFlowDesign_Impl> impl)
...
void ZoneHVACLowTempRadiantVarFlowDesign_Impl::resetHeatingControlTemperatureSchedule() {
  OS_ASSERT(setPointer(openstudio::ZoneHVAC_LowTemperatureRadiant_VariableFlow_DesignFields::HeatingControlTemperatureScheduleName, Handle(), false));
}
...
void ZoneHVACLowTempRadiantVarFlowDesign_Impl::resetCoolingControlTemperatureSchedule() {
  OS_ASSERT(setPointer(openstudio::ZoneHVAC_LowTemperatureRadiant_VariableFlow_DesignFields::CoolingControlTemperatureScheduleName, Handle(), false));
}
...
bool ZoneHVACLowTempRadiantVarFlowDesign_Impl::setChangeoverDelayTimePeriodSchedule(Schedule& schedule) {
  return setPointer(openstudio::ZoneHVAC_LowTemperatureRadiant_VariableFlow_DesignFields::ChangeoverDelayTimePeriodSchedule,
                    schedule.handle(), false);
}
...
std::string ZoneHVACLowTempRadiantVarFlowDesign_Impl::fluidtoRadiantSurfaceHeatTransferModel() const {
  if (const auto value = getString(openstudio::ZoneHVAC_LowTemperatureRadiant_VariableFlow_DesignFields::FluidtoRadiantSurfaceHeatTransferModel, true)) {
    return *value;
  }
...
double ZoneHVACLowTempRadiantVarFlowDesign_Impl::condensationControlDewpointOffset() const {
  if (const auto value = getDouble(openstudio::ZoneHVAC_LowTemperatureRadiant_VariableFlow_DesignFields::CondensationControlDewpointOffset, true)) {
    return *value;
  }
