...
#include "ModelObject/HVACSystemRootFindingAlgorithm.hpp"
...
bool HVACSystemRootFindingAlgorithm::setNumberofIterationsBeforeAlgorithmSwitch(int numberofIterationsBeforeAlgorithmSwitch) {
  return getImpl<detail::HVACSystemRootFindingAlgorithm_Impl>()->setNumberofIterationsBeforeAlgorithmSwitch(numberofIterationsBeforeAlgorithmSwitch);
}
...
void HVACSystemRootFindingAlgorithm_Impl::resetAlgorithm() {
  OS_ASSERT(setString(openstudio::HVACSystemRootFindingAlgorithmFields::Algorithm, ""));
}
