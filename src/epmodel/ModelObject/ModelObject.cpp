...
namespace epmodel {
  namespace detail {
    ...
    const ScheduleTypeSpec* findScheduleTypeSpec(const std::string& className, const std::string& scheduleDisplayName) {
      static constexpr std::array<ScheduleTypeSpec, 211> specs{{
        ...
        {"AirConditionerVariableRefrigerantFlow", "Thermostat Priority Schedule", false, true, "ControlMode", 0.0, 1.0},
        {"AirConditionerVariableRefrigerantFlow", "Basin Heater Operating Schedule", false, true, "Availability", 0.0, 1.0},
        {"ControllerOutdoorAir", "Minimum Outdoor Air", true, true, "", 0.0, 1.0},
        {"ControllerOutdoorAir", "Minimum Fraction of Outdoor Air", true, true, "", 0.0, 1.0},
        {"ControllerOutdoorAir", "Maximum Fraction of Outdoor Air", true, true, "", 0.0, 1.0},
        {"ControllerOutdoorAir", "Time of Day Economizer Control", false, true, "Availability", 0.0, 1.0},
        {"ControllerMechanicalVentilation", "Availability Schedule", false, true, "Availability", 0.0, 1.0},
        {"DesignSpecificationOutdoorAir", "Outdoor Air Flow Rate", true, true, "", 0.0, 1.0},
        {"SwimmingPoolIndoor", "Activity Factor", true, false, "", 0.0, kNoUpper},
        {"SwimmingPoolIndoor", "Make-up Water Supply", true, true, "Temperature", kNoLower, kNoUpper},
        {"SwimmingPoolIndoor", "Cover", true, false, "", 0.0, 1.0},
        {"SwimmingPoolIndoor", "Setpoint Temperature Schedule", true, true, "Temperature", kNoLower, kNoUpper},
        {"SwimmingPoolIndoor", "People Schedule", true, false, "", 0.0, 1.0},
        {"SwimmingPoolIndoor", "People Heat Gain Schedule", true, true, "ActivityLevel", 0.0, kNoUpper},
        ...
        {"SetpointManagerOutdoorAirReset", "Setpoint Manager Outdoor Air Reset", true, true, "", 0.0, kNoUpper},
        ...
        {"ZoneHVACPackagedTerminalAirConditioner", "Supply Air Fan Operating Mode", false, true, "ControlMode", 0.0, 1.0},
        {"ZoneHVACPackagedTerminalHeatPump", "Availability", false, true, "Availability", 0.0, 1.0},
        {"ZoneHVACPackagedTerminalHeatPump", "Supply Air Fan Operating Mode", false, true, "ControlMode", 0.0, 1.0},
        ...
        {"ZoneHVACEnergyRecoveryVentilatorController", "Time of Day Economizer Flow Control", true, true, "", 0.0, 1.0},
        ...
        {"CoilHeatingDXSingleSpeed", "Availability", false, true, "Availability", 0.0, 1.0},
        ...
        {"HeatExchangerAirToAirSensibleAndLatent", "Availability", false, true, "Availability", 0.0, 1.0},
        {"HeatExchangerDesiccantBalancedFlow", "Availability", false, true, "Availability", 0.0, 1.0},
        ...
        {"RefrigerationCondenserEvaporativeCooled", "Evaporative Condenser Availability", false, true, "Availability", 0.0, 1.0},
        ...
        {"CoolingTowerSingleSpeed", "Blowdown Makeup Water Usage", true, true, "VolumetricFlowRate", 0.0, kNoUpper},
        {"CoolingTowerVariableSpeed", "Basin Heater Operating Schedule", false, true, "Availability", 0.0, 1.0},
        {"CoolingTowerVariableSpeed", "Blowdown Makeup Water Usage Schedule", true, true, "VolumetricFlowRate", 0.0, kNoUpper},
        {"CoolingTowerTwoSpeed", "Basin Heater Operating", false, true, "Availability", 0.0, 1.0},
        {"CoolingTowerTwoSpeed", "Blowdown Makeup Water Usage", true, true, "VolumetricFlowRate", 0.0, kNoUpper},
        ...
        {"CoilWaterHeatingDesuperheater", "Availability", false, true, "Availability", 0.0, 1.0},
        {"CoilWaterHeatingDesuperheater", "Setpoint Temperature", true, true, "Temperature", kNoLower, kNoUpper},
