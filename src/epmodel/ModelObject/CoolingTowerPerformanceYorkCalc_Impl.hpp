...
#ifndef EPMODEL_COOLINGTOWERPERFORMANCEYORKCALC_IMPL_HPP
#define EPMODEL_COOLINGTOWERPERFORMANCEYORKCALC_IMPL_HPP
...
namespace epmodel {
  namespace detail {
    ...
    class EPMODEL_API CoolingTowerPerformanceYorkCalc_Impl : public ModelObject_Impl
    {
     public:
