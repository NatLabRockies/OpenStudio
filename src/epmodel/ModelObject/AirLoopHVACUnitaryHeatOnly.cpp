...
namespace epmodel {
  ...
  AirLoopHVACUnitaryHeatOnly::AirLoopHVACUnitaryHeatOnly(const Model& model) : ModelObject(AirLoopHVACUnitaryHeatOnly::iddObjectType(), model) {}

  AirLoopHVACUnitaryHeatOnly::AirLoopHVACUnitaryHeatOnly(std::shared_ptr<detail::AirLoopHVACUnitaryHeatOnly_Impl> impl)
  ...
  std::vector<std::string> AirLoopHVACUnitaryHeatOnly::fanPlacementValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::AirLoopHVAC_UnitaryHeatOnlyFields::FanPlacement);
  }
  ...
  // Maximum supply air temperature accessors.
  ...
  // Heating supply air flow rate accessors.
  ...
  // Supply fan object type accessors.
  ...
  // Heating coil object type accessors.
