...
#ifndef EPMODEL_FLOORDETAILED_IMPL_HPP
#define EPMODEL_FLOORDETAILED_IMPL_HPP
...
class EPMODEL_API FloorDetailed_Impl : public ModelObject_Impl
{
 public:
  using ModelObject_Impl::ModelObject_Impl;
  virtual ~FloorDetailed_Impl() override = default;
