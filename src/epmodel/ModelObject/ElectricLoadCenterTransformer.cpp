...
namespace epmodel {
  namespace detail {
    ...
    bool ElectricLoadCenterTransformer_Impl::setFractionofEddyCurrentLosses(double fractionofEddyCurrentLosses) {
      const bool result = setDouble(openstudio::ElectricLoadCenter_TransformerFields::FractionofEddyCurrentLosses, fractionofEddyCurrentLosses);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool ElectricLoadCenterTransformer_Impl::setPerUnitLoadforNameplateEfficiency(double perUnitLoadforNameplateEfficiency) {
      const bool result =
        setDouble(openstudio::ElectricLoadCenter_TransformerFields::PerUnitLoadforNameplateEfficiency, perUnitLoadforNameplateEfficiency);
      OS_ASSERT(result);
      return result;
    }
