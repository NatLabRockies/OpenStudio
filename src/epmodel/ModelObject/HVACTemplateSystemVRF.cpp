...
std::vector<std::string> HVACTemplateSystemVRF::defrostStrategyValues() {
  return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(),
                        openstudio::HVACTemplate_System_VRFFields::DefrostStrategy);
}

std::vector<std::string> HVACTemplateSystemVRF::defrostControlValues() {
  return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(),
                        openstudio::HVACTemplate_System_VRFFields::DefrostControl);
}

std::vector<std::string> HVACTemplateSystemVRF::condenserTypeValues() {
  return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(),
                        openstudio::HVACTemplate_System_VRFFields::CondenserType);
}

std::vector<std::string> HVACTemplateSystemVRF::fuelTypeValues() {
  return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(),
                        openstudio::HVACTemplate_System_VRFFields::FuelType);
}
...
OS_IMPL_REQUIRED_DOUBLE(equivalentPipingLengthusedforPipingCorrectionFactorinCoolingMode, EquivalentPipingLengthusedforPipingCorrectionFactorinCoolingMode)
OS_IMPL_REQUIRED_DOUBLE(verticalHeightusedforPipingCorrectionFactor, VerticalHeightusedforPipingCorrectionFactor)
OS_IMPL_REQUIRED_DOUBLE(equivalentPipingLengthusedforPipingCorrectionFactorinHeatingMode, EquivalentPipingLengthusedforPipingCorrectionFactorinHeatingMode)
...
OS_IMPL_DEFAULTED(isEquivalentPipingLengthusedforPipingCorrectionFactorinCoolingModeDefaulted, EquivalentPipingLengthusedforPipingCorrectionFactorinCoolingMode)
OS_IMPL_DEFAULTED(isVerticalHeightusedforPipingCorrectionFactorDefaulted, VerticalHeightusedforPipingCorrectionFactor)
OS_IMPL_DEFAULTED(isEquivalentPipingLengthusedforPipingCorrectionFactorinHeatingModeDefaulted, EquivalentPipingLengthusedforPipingCorrectionFactorinHeatingMode)
...
OS_IMPL_SET_DOUBLE(setEquivalentPipingLengthusedforPipingCorrectionFactorinCoolingMode, EquivalentPipingLengthusedforPipingCorrectionFactorinCoolingMode)
OS_IMPL_SET_DOUBLE(setVerticalHeightusedforPipingCorrectionFactor, VerticalHeightusedforPipingCorrectionFactor)
OS_IMPL_SET_DOUBLE(setEquivalentPipingLengthusedforPipingCorrectionFactorinHeatingMode, EquivalentPipingLengthusedforPipingCorrectionFactorinHeatingMode)
...
OS_IMPL_RESET(resetEquivalentPipingLengthusedforPipingCorrectionFactorinCoolingMode, EquivalentPipingLengthusedforPipingCorrectionFactorinCoolingMode)
OS_IMPL_RESET(resetVerticalHeightusedforPipingCorrectionFactor, VerticalHeightusedforPipingCorrectionFactor)
OS_IMPL_RESET(resetEquivalentPipingLengthusedforPipingCorrectionFactorinHeatingMode, EquivalentPipingLengthusedforPipingCorrectionFactorinHeatingMode)
