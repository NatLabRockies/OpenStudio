...
#ifndef EPMODEL_HVACTEMPLATEZONEUNITARY_IMPL_HPP
#define EPMODEL_HVACTEMPLATEZONEUNITARY_IMPL_HPP
...
class EPMODEL_API HVACTemplateZoneUnitary_Impl : public ModelObject_Impl
{
 public:
  using ModelObject_Impl::ModelObject_Impl;
  virtual ~HVACTemplateZoneUnitary_Impl() override = default;
