...
namespace epmodel {
  ...
  bool AirflowNetworkDistributionComponentOutdoorAirFlow::setAirMassFlowExponentWhenNoOutdoorAirFlow(double airMassFlowExponentWhenNoOutdoorAirFlow) {
    return getImpl<detail::AirflowNetworkDistributionComponentOutdoorAirFlow_Impl>()->setAirMassFlowExponentWhenNoOutdoorAirFlow(
...
namespace epmodel {
  namespace detail {
    ...
    double AirflowNetworkDistributionComponentOutdoorAirFlow_Impl::airMassFlowExponentWhenNoOutdoorAirFlow() const {
      const auto value =
        getDouble(openstudio::AirflowNetwork_Distribution_Component_OutdoorAirFlowFields::AirMassFlowExponentWhenNoOutdoorAirFlow, true);
      OS_ASSERT(value);
      return *value;
    }
