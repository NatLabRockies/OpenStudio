...
MaterialPropertyVariableAbsorptance::MaterialPropertyVariableAbsorptance(
  std::shared_ptr<detail::MaterialPropertyVariableAbsorptance_Impl> impl)
...
bool MaterialPropertyVariableAbsorptance_Impl::setThermalAbsorptanceFunctionName(const std::string& thermalAbsorptanceFunctionName) {
  return setString(openstudio::MaterialProperty_VariableAbsorptanceFields::ThermalAbsorptanceFunctionName,
                   thermalAbsorptanceFunctionName);
}
...
bool MaterialPropertyVariableAbsorptance_Impl::setThermalAbsorptanceScheduleName(const std::string& thermalAbsorptanceScheduleName) {
  return setString(openstudio::MaterialProperty_VariableAbsorptanceFields::ThermalAbsorptanceScheduleName,
                   thermalAbsorptanceScheduleName);
}
