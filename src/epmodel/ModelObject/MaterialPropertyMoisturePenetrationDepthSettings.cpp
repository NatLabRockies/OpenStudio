...
bool MaterialPropertyMoisturePenetrationDepthSettings_Impl::setWaterVaporDiffusionResistanceFactor(double waterVaporDiffusionResistanceFactor) {
  const bool result =
    setDouble(openstudio::MaterialProperty_MoisturePenetrationDepth_SettingsFields::WaterVaporDiffusionResistanceFactor,
              waterVaporDiffusionResistanceFactor);
  OS_ASSERT(result);
  return result;
}
...
bool MaterialPropertyMoisturePenetrationDepthSettings_Impl::setMoistureEquationCoefficientA(double moistureEquationCoefficientA) {
  const bool result = setDouble(openstudio::MaterialProperty_MoisturePenetrationDepth_SettingsFields::MoistureEquationCoefficienta,
...
bool MaterialPropertyMoisturePenetrationDepthSettings_Impl::setMoistureEquationCoefficientB(double moistureEquationCoefficientB) {
  const bool result = setDouble(openstudio::MaterialProperty_MoisturePenetrationDepth_SettingsFields::MoistureEquationCoefficientb,
...
bool MaterialPropertyMoisturePenetrationDepthSettings_Impl::setMoistureEquationCoefficientC(double moistureEquationCoefficientC) {
  const bool result = setDouble(openstudio::MaterialProperty_MoisturePenetrationDepth_SettingsFields::MoistureEquationCoefficientc,
...
bool MaterialPropertyMoisturePenetrationDepthSettings_Impl::setMoistureEquationCoefficientD(double moistureEquationCoefficientD) {
  const bool result = setDouble(openstudio::MaterialProperty_MoisturePenetrationDepth_SettingsFields::MoistureEquationCoefficientd,
                                moistureEquationCoefficientD);
  OS_ASSERT(result);
  return result;
}
...
bool MaterialPropertyMoisturePenetrationDepthSettings_Impl::setSurfaceLayerPenetrationDepth(double surfaceLayerPenetrationDepth) {
  const bool result =
    setDouble(openstudio::MaterialProperty_MoisturePenetrationDepth_SettingsFields::SurfaceLayerPenetrationDepth,
              surfaceLayerPenetrationDepth);
  OS_ASSERT(result);
  return result;
}
...
bool MaterialPropertyMoisturePenetrationDepthSettings_Impl::setDeepLayerPenetrationDepth(double deepLayerPenetrationDepth) {
  const bool result = setDouble(openstudio::MaterialProperty_MoisturePenetrationDepth_SettingsFields::DeepLayerPenetrationDepth,
                                deepLayerPenetrationDepth);
  OS_ASSERT(result);
  return result;
}
...
double MaterialPropertyMoisturePenetrationDepthSettings_Impl::coatingLayerWaterVaporDiffusionResistanceFactor() const {
  const auto value = getDouble(openstudio::MaterialProperty_MoisturePenetrationDepth_SettingsFields::CoatingLayerWaterVaporDiffusionResistanceFactor,
                               true);
  OS_ASSERT(value);
  return *value;
}
...
bool MaterialPropertyMoisturePenetrationDepthSettings_Impl::setCoatingLayerWaterVaporDiffusionResistanceFactor(
  ...
  const bool result = setDouble(
    openstudio::MaterialProperty_MoisturePenetrationDepth_SettingsFields::CoatingLayerWaterVaporDiffusionResistanceFactor,
    coatingLayerWaterVaporDiffusionResistanceFactor);
  OS_ASSERT(result);
  return result;
}
