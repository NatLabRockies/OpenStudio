...
#ifndef EPMODEL_SITEGROUNDTEMPERATUREBUILDINGSURFACE_IMPL_HPP
#define EPMODEL_SITEGROUNDTEMPERATUREBUILDINGSURFACE_IMPL_HPP
...
namespace epmodel {
  ...
  namespace detail {
    ...
    class EPMODEL_API SiteGroundTemperatureBuildingSurface_Impl : public ModelObject_Impl
    {
     public:
