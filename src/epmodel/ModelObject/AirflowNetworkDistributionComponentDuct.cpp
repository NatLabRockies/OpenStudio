...
namespace epmodel {
  namespace detail {
    ...
    bool
      AirflowNetworkDistributionComponentDuct_Impl::setCoefficientforLocalDynamicLossDuetoFitting(double coefficientforLocalDynamicLossDuetoFitting) {
    ...
    void AirflowNetworkDistributionComponentDuct_Impl::resetHeatTransmittanceCoefficientUFactorforDuctWallConstruction() {
      OS_ASSERT(
        setString(openstudio::AirflowNetwork_Distribution_Component_DuctFields::HeatTransmittanceCoefficient_UFactor_forDuctWallConstruction, ""));
    }

    double AirflowNetworkDistributionComponentDuct_Impl::overallMoistureTransmittanceCoefficientfromAirtoAir() const {
      const auto value =
        getDouble(openstudio::AirflowNetwork_Distribution_Component_DuctFields::OverallMoistureTransmittanceCoefficientfromAirtoAir, true);
      OS_ASSERT(value);
      return *value;
    }
