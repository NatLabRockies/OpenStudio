...
HVACTemplateSystemConstantVolume::HVACTemplateSystemConstantVolume(const Model& model) : ModelObject(HVACTemplateSystemConstantVolume::iddObjectType(), model) {}

HVACTemplateSystemConstantVolume::HVACTemplateSystemConstantVolume(std::shared_ptr<detail::HVACTemplateSystemConstantVolume_Impl> impl) : ModelObject(std::move(impl)) {}
...
bool HVACTemplateSystemConstantVolume::setCoolingCoilSetpointatOutdoorDryBulbLow(double coolingCoilSetpointatOutdoorDryBulbLow) {
  return getImpl<detail::HVACTemplateSystemConstantVolume_Impl>()->setCoolingCoilSetpointatOutdoorDryBulbLow(coolingCoilSetpointatOutdoorDryBulbLow);
}
...
bool HVACTemplateSystemConstantVolume::setCoolingCoilSetpointatOutdoorDryBulbHigh(double coolingCoilSetpointatOutdoorDryBulbHigh) {
  return getImpl<detail::HVACTemplateSystemConstantVolume_Impl>()->setCoolingCoilSetpointatOutdoorDryBulbHigh(coolingCoilSetpointatOutdoorDryBulbHigh);
}
...
bool HVACTemplateSystemConstantVolume::setHeatingCoilSetpointatOutdoorDryBulbLow(double heatingCoilSetpointatOutdoorDryBulbLow) {
  return getImpl<detail::HVACTemplateSystemConstantVolume_Impl>()->setHeatingCoilSetpointatOutdoorDryBulbLow(heatingCoilSetpointatOutdoorDryBulbLow);
}
...
bool HVACTemplateSystemConstantVolume::setHeatingCoilSetpointatOutdoorDryBulbHigh(double heatingCoilSetpointatOutdoorDryBulbHigh) {
  return getImpl<detail::HVACTemplateSystemConstantVolume_Impl>()->setHeatingCoilSetpointatOutdoorDryBulbHigh(heatingCoilSetpointatOutdoorDryBulbHigh);
}
...
bool HVACTemplateSystemConstantVolume::setEconomizerMaximumLimitDewpointTemperature(double economizerMaximumLimitDewpointTemperature) {
  return getImpl<detail::HVACTemplateSystemConstantVolume_Impl>()->setEconomizerMaximumLimitDewpointTemperature(economizerMaximumLimitDewpointTemperature);
}
...
bool HVACTemplateSystemConstantVolume::setDehumidificationRelativeHumiditySetpoint(double dehumidificationRelativeHumiditySetpoint) {
  return getImpl<detail::HVACTemplateSystemConstantVolume_Impl>()->setDehumidificationRelativeHumiditySetpoint(dehumidificationRelativeHumiditySetpoint);
}
