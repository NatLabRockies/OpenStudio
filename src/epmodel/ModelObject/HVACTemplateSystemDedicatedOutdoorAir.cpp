...
#define OS_FORWARD_VOID(method)                                              \
  ...
  // Field-specific accessors grouped together for clarity
  // airOutletType
  ...
  // coolingCoilSetpointControlType
  ...
  // coolingCoilResetOutdoorDryBulbLow
  ...
  // coolingCoilResetOutdoorDryBulbHigh
  ...
  // dXCoolingCoilGrossRatedTotalCapacity
  ...
  // heatingCoilSetpointControlType
  ...
  // heatingCoilResetOutdoorDryBulbLow
  ...
  // heatingCoilResetOutdoorDryBulbHigh
  ...
  // heatRecoverySensibleEffectiveness
  ...
  // heatRecoveryLatentEffectiveness
