...
#ifndef EPMODEL_HVACTEMPLATEZONEVAVHEATANDCOOL_IMPL_HPP
#define EPMODEL_HVACTEMPLATEZONEVAVHEATANDCOOL_IMPL_HPP
...
class EPMODEL_API HVACTemplateZoneVAVHeatAndCool_Impl : public ModelObject_Impl
{
 public:
  using ModelObject_Impl::ModelObject_Impl;
  virtual ~HVACTemplateZoneVAVHeatAndCool_Impl() override = default;
