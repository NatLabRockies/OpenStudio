...
GroundHeatTransferBasementInsulation::GroundHeatTransferBasementInsulation(
  std::shared_ptr<detail::GroundHeatTransferBasementInsulation_Impl> impl)
...
bool GroundHeatTransferBasementInsulation::setREXTRValueofanyexteriorinsulation(double rEXTRValueofanyexteriorinsulation) {
  return getImpl<detail::GroundHeatTransferBasementInsulation_Impl>()->setREXTRValueofanyexteriorinsulation(
...
bool GroundHeatTransferBasementInsulation::setINSFULLFlagIsthewallfullyinsulated(bool iNSFULLFlagIsthewallfullyinsulated) {
  return getImpl<detail::GroundHeatTransferBasementInsulation_Impl>()->setINSFULLFlagIsthewallfullyinsulated(
    iNSFULLFlagIsthewallfullyinsulated);
}
