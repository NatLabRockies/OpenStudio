...
EnvironmentalImpactFactors::EnvironmentalImpactFactors(const Model& model)
  : ModelObject(EnvironmentalImpactFactors::iddObjectType(), model) {
...
bool EnvironmentalImpactFactors::setDistrictHeatingSteamConversionEfficiency(double districtHeatingSteamConversionEfficiency) {
  return getImpl<detail::EnvironmentalImpactFactors_Impl>()->setDistrictHeatingSteamConversionEfficiency(
...
bool EnvironmentalImpactFactors_Impl::setTotalCarbonEquivalentEmissionFactorFromN2O(double totalCarbonEquivalentEmissionFactorFromN2O) {
  const bool result =
    setDouble(openstudio::EnvironmentalImpactFactorsFields::TotalCarbonEquivalentEmissionFactorFromN2O, totalCarbonEquivalentEmissionFactorFromN2O);
  OS_ASSERT(result);
  return result;
}
...
bool EnvironmentalImpactFactors_Impl::setTotalCarbonEquivalentEmissionFactorFromCH4(double totalCarbonEquivalentEmissionFactorFromCH4) {
  const bool result =
    setDouble(openstudio::EnvironmentalImpactFactorsFields::TotalCarbonEquivalentEmissionFactorFromCH4, totalCarbonEquivalentEmissionFactorFromCH4);
  OS_ASSERT(result);
  return result;
}
...
bool EnvironmentalImpactFactors_Impl::setTotalCarbonEquivalentEmissionFactorFromCO2(double totalCarbonEquivalentEmissionFactorFromCO2) {
  const bool result =
    setDouble(openstudio::EnvironmentalImpactFactorsFields::TotalCarbonEquivalentEmissionFactorFromCO2, totalCarbonEquivalentEmissionFactorFromCO2);
  OS_ASSERT(result);
  return result;
}
