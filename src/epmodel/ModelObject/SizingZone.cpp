...
bool SizingZone_Impl::setAccountforDedicatedOutdoorAirSystem(bool accountforDedicatedOutdoorAirSystem) {
  const bool result = setString(openstudio::Sizing_ZoneFields::AccountforDedicatedOutdoorAirSystem,
                                accountforDedicatedOutdoorAirSystem ? "Yes" : "No");
  OS_ASSERT(result);
  return result;
}
...
bool SizingZone_Impl::setZoneHumidificationDesignSupplyAirHumidityRatio(double zoneHumidificationDesignSupplyAirHumidityRatio) {
  return setDouble(openstudio::Sizing_ZoneFields::ZoneHumidificationDesignSupplyAirHumidityRatio,
...
bool SizingZone_Impl::setZoneHumidificationDesignSupplyAirHumidityRatioDifference(double zoneHumidificationDesignSupplyAirHumidityRatioDifference) {
...
bool SizingZone_Impl::setMaximumHeatingCapacityToCoolingLoadSizingRatio(double maximumHeatingCapacityToCoolingLoadSizingRatio) {
  return setDouble(openstudio::Sizing_ZoneFields::MaximumHeatingCapacityToCoolingLoadSizingRatio,
