...
bool PipingSystemUndergroundDomain::setShiftPipeXCoordinatesByBasementWidth(
  boost::optional<bool> shiftPipeXCoordinatesByBasementWidth) {
  return getImpl<detail::PipingSystemUndergroundDomain_Impl>()->setShiftPipeXCoordinatesByBasementWidth(
    shiftPipeXCoordinatesByBasementWidth);
}
...
bool PipingSystemUndergroundDomain::setEvapotranspirationGroundCoverParameter(double evapotranspirationGroundCoverParameter) {
  return getImpl<detail::PipingSystemUndergroundDomain_Impl>()->setEvapotranspirationGroundCoverParameter(
...
bool PipingSystemUndergroundDomain_Impl::setSoilMoistureContentVolumeFractionatSaturation(
...
bool PipingSystemUndergroundDomain_Impl::setWidthofBasementFloorinGroundDomain(double widthofBasementFloorinGroundDomain) {
  const bool result = setDouble(openstudio::PipingSystem_Underground_DomainFields::WidthofBasementFloorinGroundDomain,
                                widthofBasementFloorinGroundDomain);
  OS_ASSERT(result);
  return result;
}
...
bool PipingSystemUndergroundDomain_Impl::setShiftPipeXCoordinatesByBasementWidth(
  boost::optional<bool> shiftPipeXCoordinatesByBasementWidth) {
  bool result = false;
