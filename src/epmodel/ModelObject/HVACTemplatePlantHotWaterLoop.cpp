...
bool HVACTemplatePlantHotWaterLoop_Impl::setHotWaterSetpointatOutdoorDryBulbHigh(double hotWaterSetpointatOutdoorDryBulbHigh) {
  const bool result = setDouble(openstudio::HVACTemplate_Plant_HotWaterLoopFields::HotWaterSetpointatOutdoorDryBulbHigh,
...
bool HVACTemplatePlantHotWaterLoop_Impl::setSupplySideBypassPipe(bool supplySideBypassPipe) {
  const bool result =
    setBooleanFieldValue(*this, openstudio::HVACTemplate_Plant_HotWaterLoopFields::SupplySideBypassPipe, supplySideBypassPipe);
  OS_ASSERT(result);
  return result;
}
...
bool HVACTemplatePlantHotWaterLoop_Impl::setDemandSideBypassPipe(bool demandSideBypassPipe) {
  const bool result =
    setBooleanFieldValue(*this, openstudio::HVACTemplate_Plant_HotWaterLoopFields::DemandSideBypassPipe, demandSideBypassPipe);
  OS_ASSERT(result);
  return result;
}
