...
namespace epmodel {
  namespace detail {
    ...
    openstudio::epmodel::NodeList NodeList_Impl::ensureAttachedNodeList(LoadContext& context, openstudio::epmodel::ModelObject& owner,
      ...
      auto singleNode = owner.getImpl<openstudio::epmodel::detail::ModelObject_Impl>()->resolvedNodeTarget(fieldIndex);
      ...
      if (singleNode) {
        if (!nodeList.getImpl<openstudio::epmodel::detail::NodeList_Impl>()->addNode(*singleNode)) {
          LOG_FREE_AND_THROW("openstudio.epmodel.NodeList",
                             "Failed to add existing node '" << singleNode->nameString() << "' to NodeList '" << nodeList.nameString() << "'.");
        }
      ...
      detail::addLoadInfo(context,
                          "Created NodeList '" + nodeList.nameString() + "' and node '" + createdNode.nameString() + "' for '" + ownerName + "'.");
      return nodeList;
    }
