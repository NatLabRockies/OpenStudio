...
#ifndef EPMODEL_FLOORGROUNDCONTACT_IMPL_HPP
#define EPMODEL_FLOORGROUNDCONTACT_IMPL_HPP
...
class EPMODEL_API FloorGroundContact_Impl : public ModelObject_Impl
{
 public:
  using ModelObject_Impl::ModelObject_Impl;
  virtual ~FloorGroundContact_Impl() override = default;
