...
#ifndef EPMODEL_FLOORADIABATIC_IMPL_HPP
#define EPMODEL_FLOORADIABATIC_IMPL_HPP
...
class EPMODEL_API FloorAdiabatic_Impl : public ModelObject_Impl
{
 public:
  using ModelObject_Impl::ModelObject_Impl;
  virtual ~FloorAdiabatic_Impl() override = default;
