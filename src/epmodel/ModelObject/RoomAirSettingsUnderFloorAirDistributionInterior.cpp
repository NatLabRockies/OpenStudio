...
bool RoomAirSettingsUnderFloorAirDistributionInterior::setTemperatureDifferenceThresholdforReporting(double temperatureDifferenceThresholdforReporting) {
...
RoomAirSettingsUnderFloorAirDistributionInterior::coefficientA() const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->coefficientA();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::isCoefficientADefaulted()
  const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->isCoefficientADefaulted();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::isCoefficientAAutocalculated()
  const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->isCoefficientAAutocalculated();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::setCoefficientA(
  double coefficientA) {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->setCoefficientA(
      coefficientA);
...
void RoomAirSettingsUnderFloorAirDistributionInterior::resetCoefficientA() {
  getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->resetCoefficientA();
}

void RoomAirSettingsUnderFloorAirDistributionInterior::autocalculateCoefficientA() {
  getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->autocalculateCoefficientA();
}

boost::optional<double>
RoomAirSettingsUnderFloorAirDistributionInterior::coefficientB() const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->coefficientB();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::isCoefficientBDefaulted()
  const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->isCoefficientBDefaulted();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::isCoefficientBAutocalculated()
  const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->isCoefficientBAutocalculated();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::setCoefficientB(
  double coefficientB) {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->setCoefficientB(
      coefficientB);
...
void RoomAirSettingsUnderFloorAirDistributionInterior::autocalculateCoefficientB() {
  getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->autocalculateCoefficientB();
}

boost::optional<double>
RoomAirSettingsUnderFloorAirDistributionInterior::coefficientC() const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->coefficientC();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::isCoefficientCDefaulted()
  const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->isCoefficientCDefaulted();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::isCoefficientCAutocalculated()
  const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->isCoefficientCAutocalculated();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::setCoefficientC(
  double coefficientC) {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->setCoefficientC(
      coefficientC);
...
void RoomAirSettingsUnderFloorAirDistributionInterior::autocalculateCoefficientC() {
  getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->autocalculateCoefficientC();
}

boost::optional<double>
RoomAirSettingsUnderFloorAirDistributionInterior::coefficientD() const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->coefficientD();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::isCoefficientDDefaulted()
  const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->isCoefficientDDefaulted();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::isCoefficientDAutocalculated()
  const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->isCoefficientDAutocalculated();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::setCoefficientD(
  double coefficientD) {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->setCoefficientD(
      coefficientD);
...
void RoomAirSettingsUnderFloorAirDistributionInterior::autocalculateCoefficientD() {
  getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->autocalculateCoefficientD();
}

boost::optional<double>
RoomAirSettingsUnderFloorAirDistributionInterior::coefficientE() const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->coefficientE();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::isCoefficientEDefaulted()
  const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->isCoefficientEDefaulted();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::isCoefficientEAutocalculated()
  const {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->isCoefficientEAutocalculated();
}

bool RoomAirSettingsUnderFloorAirDistributionInterior::setCoefficientE(
  double coefficientE) {
  return getImpl<detail::RoomAirSettingsUnderFloorAirDistributionInterior_Impl>()
    ->setCoefficientE(
      coefficientE);
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::setDiffuserSlotAnglefromVertical(double diffuserSlotAnglefromVertical) {
  return setDouble(openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::DiffuserSlotAnglefromVertical, diffuserSlotAnglefromVertical);
}
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::setTemperatureDifferenceThresholdforReporting(double temperatureDifferenceThresholdforReporting) {
...
boost::optional<double>
RoomAirSettingsUnderFloorAirDistributionInterior_Impl::coefficientA() const {
  return getDouble(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientA,
    true);
}

bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::isCoefficientADefaulted()
  const {
  return isEmpty(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientA);
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::isCoefficientAAutocalculated()
  const {
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::setCoefficientA(
  double coefficientA) {
...
boost::optional<double>
RoomAirSettingsUnderFloorAirDistributionInterior_Impl::coefficientB() const {
  return getDouble(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientB,
    true);
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::isCoefficientBDefaulted()
  const {
  return isEmpty(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientB);
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::isCoefficientBAutocalculated()
  const {
  if (const auto value = getString(
        openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
          CoefficientB,
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::setCoefficientB(
  double coefficientB) {
  const bool result = setDouble(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientB,
...
boost::optional<double>
RoomAirSettingsUnderFloorAirDistributionInterior_Impl::coefficientC() const {
  return getDouble(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientC,
    true);
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::isCoefficientCDefaulted()
  const {
  return isEmpty(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientC);
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::isCoefficientCAutocalculated()
  const {
  if (const auto value = getString(
        openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
          CoefficientC,
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::setCoefficientC(
  double coefficientC) {
  const bool result = setDouble(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientC,
...
boost::optional<double>
RoomAirSettingsUnderFloorAirDistributionInterior_Impl::coefficientD() const {
  return getDouble(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientD,
    true);
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::isCoefficientDDefaulted()
  const {
  return isEmpty(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientD);
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::isCoefficientDAutocalculated()
  const {
  if (const auto value = getString(
        openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
          CoefficientD,
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::setCoefficientD(
  double coefficientD) {
  const bool result = setDouble(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientD,
...
boost::optional<double>
RoomAirSettingsUnderFloorAirDistributionInterior_Impl::coefficientE() const {
  return getDouble(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientE,
    true);
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::isCoefficientEDefaulted()
  const {
  return isEmpty(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientE);
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::isCoefficientEAutocalculated()
  const {
  if (const auto value = getString(
        openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
          CoefficientE,
...
bool RoomAirSettingsUnderFloorAirDistributionInterior_Impl::setCoefficientE(
  double coefficientE) {
  const bool result = setDouble(
    openstudio::RoomAirSettings_UnderFloorAirDistributionInteriorFields::
      CoefficientE,
