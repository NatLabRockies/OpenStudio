...
bool SetpointManagerCondenserEnteringReset::setMaximumCondenserEnteringWaterTemperature(double maximumCondenserEnteringWaterTemperature) {
  return getImpl<detail::SetpointManagerCondenserEnteringReset_Impl>()
...
bool SetpointManagerCondenserEnteringReset::setCoolingTowerDesignInletAirWetBulbTemperature(double coolingTowerDesignInletAirWetBulbTemperature) {
  return getImpl<detail::SetpointManagerCondenserEnteringReset_Impl>()
    ->setCoolingTowerDesignInletAirWetBulbTemperature(coolingTowerDesignInletAirWetBulbTemperature);
}
...
double SetpointManagerCondenserEnteringReset_Impl::coolingTowerDesignInletAirWetBulbTemperature() const {
  const auto value =
    getDouble(openstudio::SetpointManager_CondenserEnteringResetFields::CoolingTowerDesignInletAirWetBulbTemperature, true);
  OS_ASSERT(value);
  return *value;
}
...
bool SetpointManagerCondenserEnteringReset_Impl::setCoolingTowerDesignInletAirWetBulbTemperature(double coolingTowerDesignInletAirWetBulbTemperature) {
  const bool result =
    setDouble(openstudio::SetpointManager_CondenserEnteringResetFields::CoolingTowerDesignInletAirWetBulbTemperature,
