...
namespace epmodel {
  ...
  /** \brief Represents a biquadratic curve.
   *
   * \par EnergyPlus object
   * \epobject{group-performance-curves.html#curvebiquadratic,Curve:Biquadratic}
   *
   * \par OpenStudio Model API
   * The corresponding OpenStudio Model class is
   * <code>openstudio::model::CurveBiquadratic</code>.
