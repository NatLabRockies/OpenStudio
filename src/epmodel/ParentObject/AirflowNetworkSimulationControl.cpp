...
namespace epmodel {
  ...
  std::vector<std::string> AirflowNetworkSimulationControl::buildingTypeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::AirflowNetwork_SimulationControlFields::BuildingType);
  }
  ...
  std::vector<std::string> AirflowNetworkSimulationControl::solverValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::AirflowNetwork_SimulationControlFields::Solver);
  }
...
namespace epmodel {
  namespace detail {
    ...
    bool AirflowNetworkSimulationControl_Impl::setRelativeAirflowConvergenceTolerance(double relativeAirflowConvergenceTolerance) {
      return setDouble(openstudio::AirflowNetwork_SimulationControlFields::RelativeAirflowConvergenceTolerance, relativeAirflowConvergenceTolerance);
    }
    ...
    bool AirflowNetworkSimulationControl_Impl::setAbsoluteAirflowConvergenceTolerance(double absoluteAirflowConvergenceTolerance) {
      return setDouble(openstudio::AirflowNetwork_SimulationControlFields::AbsoluteAirflowConvergenceTolerance, absoluteAirflowConvergenceTolerance);
    }
    ...
    double AirflowNetworkSimulationControl_Impl::ratioofBuildingWidthAlongShortAxistoWidthAlongLongAxis() const {
      const auto value = getDouble(openstudio::AirflowNetwork_SimulationControlFields::RatioofBuildingWidthAlongShortAxistoWidthAlongLongAxis, true);
      OS_ASSERT(value);
      return *value;
    }
    ...
    void AirflowNetworkSimulationControl_Impl::setAllowUnsupportedZoneEquipment(bool allowUnsupportedZoneEquipment) {
      OS_ASSERT(
        setString(openstudio::AirflowNetwork_SimulationControlFields::AllowUnsupportedZoneEquipment, allowUnsupportedZoneEquipment ? "Yes" : "No"));
    }
