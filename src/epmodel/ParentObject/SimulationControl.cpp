...
bool SimulationControl_Impl::setRunSimulationforWeatherFileRunPeriods(bool runSimulationforWeatherFileRunPeriods) {
  const bool result = setString(openstudio::SimulationControlFields::RunSimulationforWeatherFileRunPeriods,
                                runSimulationforWeatherFileRunPeriods ? "Yes" : "No");
  OS_ASSERT(result);
  return result;
}
...
bool SimulationControl_Impl::setDoHVACSizingSimulationforSizingPeriods(bool doHVACSizingSimulationforSizingPeriods) {
  const bool result = setString(openstudio::SimulationControlFields::DoHVACSizingSimulationforSizingPeriods,
                                doHVACSizingSimulationforSizingPeriods ? "Yes" : "No");
  OS_ASSERT(result);
  return result;
}
