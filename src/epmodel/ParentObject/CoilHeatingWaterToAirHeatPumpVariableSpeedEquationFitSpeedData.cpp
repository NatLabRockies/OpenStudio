...
namespace epmodel {
  ...
  namespace {
    ...
    std::shared_ptr<detail::CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFitSpeedData_Impl> makeDetachedSpeedDataImpl(const Model& model) {
      const auto generatedName = "__transient__heating_wtahp_vs_speed_data_" + openstudio::toString(openstudio::createUUID());
      auto transient = model.getOrCreateTransientByName<CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFitSpeedData>(generatedName);
...
namespace epmodel {
  namespace detail {
    ...
    boost::optional<CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFit>
      CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFitSpeedData_Impl::parent() const {
