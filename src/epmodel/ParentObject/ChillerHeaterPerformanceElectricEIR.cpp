...
namespace epmodel {
  namespace detail {
    ...
    double ChillerHeaterPerformanceElectricEIR_Impl::referenceHeatingModeLeavingChilledWaterTemperature() const {
      const auto value = getDouble(openstudio::ChillerHeaterPerformance_Electric_EIRFields::ReferenceHeatingModeLeavingChilledWaterTemperature, true);
      OS_ASSERT(value);
      return *value;
    }
    ...
    double ChillerHeaterPerformanceElectricEIR_Impl::heatingModeEnteringChilledWaterTemperatureLowLimit() const {
      const auto value = getDouble(openstudio::ChillerHeaterPerformance_Electric_EIRFields::HeatingModeEnteringChilledWaterTemperatureLowLimit, true);
      OS_ASSERT(value);
      return *value;
    }
