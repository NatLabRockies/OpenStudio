...
class EPMODEL_API CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFitSpeedData : public ParentObject
{
 public:
  ...
  CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFitSpeedData(
    const CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFitSpeedData& other) = default;
  CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFitSpeedData(CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFitSpeedData&& other) =
    default;
  CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFitSpeedData&
