...
namespace epmodel {
  ...
  std::vector<std::string> ChillerElectricASHRAE205::chillerFlowModeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::Chiller_Electric_ASHRAE205Fields::ChillerFlowMode);
  }
...
namespace epmodel {
  namespace detail {
    ...
    bool ChillerElectricASHRAE205_Impl::setAmbientTemperatureSchedule(Schedule& schedule) {
      const bool result = setSchedule(openstudio::Chiller_Electric_ASHRAE205Fields::AmbientTemperatureScheduleName, "ChillerElectricASHRAE205",
    ...
    bool ChillerElectricASHRAE205_Impl::setAmbientTemperatureOutdoorAirNodeName(const std::string& ambientTemperatureOutdoorAirNodeName) {
      const bool result =
        setString(openstudio::Chiller_Electric_ASHRAE205Fields::AmbientTemperatureOutdoorAirNodeName, ambientTemperatureOutdoorAirNodeName);
      if (result) {
    ...
    bool ChillerElectricASHRAE205_Impl::setAuxiliaryCoolingDesignFlowRate(double auxiliaryCoolingDesignFlowRate) {
      const bool result = setDouble(openstudio::Chiller_Electric_ASHRAE205Fields::AuxiliaryCoolingDesignFlowRate, auxiliaryCoolingDesignFlowRate);
      return result;
    }
