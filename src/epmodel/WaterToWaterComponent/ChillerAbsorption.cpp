...
namespace epmodel {
  namespace detail {
    ...
    bool ChillerAbsorption_Impl::setChilledWaterOutletTemperatureLowerLimit(double chilledWaterOutletTemperatureLowerLimit) {
      const bool result =
        setDouble(openstudio::Chiller_AbsorptionFields::ChilledWaterOutletTemperatureLowerLimit, chilledWaterOutletTemperatureLowerLimit);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool ChillerAbsorption_Impl::setDegreeofSubcoolinginSteamGenerator(double degreeofSubcoolinginSteamGenerator) {
      const bool result = setDouble(openstudio::Chiller_AbsorptionFields::DegreeofSubcoolinginSteamGenerator, degreeofSubcoolinginSteamGenerator);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool ChillerAbsorption_Impl::addToTertiaryNode(Node& node) {
      ...
      if (ok) {
        LOG_FREE(Info, "openstudio.epmodel.ChillerAbsorption", "Setting Generator Heat Source Type to 'HotWater' for " << briefDescription());
