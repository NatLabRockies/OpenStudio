...
bool BoilerSteam_Impl::setCoefficient1ofFuelUseFunctionofPartLoadRatioCurve(double coefficient1ofFuelUseFunctionofPartLoadRatioCurve) {
  const bool result =
    setDouble(openstudio::Boiler_SteamFields::Coefficient1ofFuelUseFunctionofPartLoadRatioCurve, coefficient1ofFuelUseFunctionofPartLoadRatioCurve);
  OS_ASSERT(result);
  return result;
}
...
bool BoilerSteam_Impl::setCoefficient2ofFuelUseFunctionofPartLoadRatioCurve(double coefficient2ofFuelUseFunctionofPartLoadRatioCurve) {
  const bool result =
    setDouble(openstudio::Boiler_SteamFields::Coefficient2ofFuelUseFunctionofPartLoadRatioCurve, coefficient2ofFuelUseFunctionofPartLoadRatioCurve);
  OS_ASSERT(result);
  return result;
}
...
bool BoilerSteam_Impl::setCoefficient3ofFuelUseFunctionofPartLoadRatioCurve(double coefficient3ofFuelUseFunctionofPartLoadRatioCurve) {
  const bool result =
    setDouble(openstudio::Boiler_SteamFields::Coefficient3ofFuelUseFunctionofPartLoadRatioCurve, coefficient3ofFuelUseFunctionofPartLoadRatioCurve);
  OS_ASSERT(result);
  return result;
}
