...
namespace epmodel {
  namespace detail {
    ...
    namespace {
      ...
      bool removeTransientRadiantParentFromPlantLoop(const CoilHeatingLowTempRadiantVarFlow_Impl& coilImpl, ModelObject parentObject,
    ...
    bool CoilHeatingLowTempRadiantVarFlow_Impl::addToNode(Node& node) {
      ...
      return addTransientRadiantParentToPlantNode(
        node, p->cast<ModelObject>(), openstudio::ZoneHVAC_LowTemperatureRadiant_VariableFlowFields::HeatingWaterInletNodeName,
        openstudio::ZoneHVAC_LowTemperatureRadiant_VariableFlowFields::HeatingWaterOutletNodeName, "Heating Coil");
    }
