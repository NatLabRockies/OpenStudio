...
namespace epmodel {
  ...
  std::vector<std::string> HumidifierSteamGas::inletWaterTemperatureOptionValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(),
                          openstudio::Humidifier_Steam_GasFields::InletWaterTemperatureOption);
  }
...
namespace epmodel {
  namespace detail {
    ...
    bool HumidifierSteamGas_Impl::setAvailabilitySchedule(Schedule& schedule) {
      return ModelObject_Impl::setSchedule(openstudio::Humidifier_Steam_GasFields::AvailabilityScheduleName, "HumidifierSteamGas", "Availability",
                                           schedule);
    }
