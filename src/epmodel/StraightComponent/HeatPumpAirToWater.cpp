...
namespace epmodel {
  ...
  std::vector<std::string> HeatPumpAirToWater::operatingModeControlMethodValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::HeatPump_AirToWaterFields::OperatingModeControlMethod);
  }
  ...
  std::vector<std::string> HeatPumpAirToWater::heatPumpDefrostControlValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::HeatPump_AirToWaterFields::HeatPumpDefrostControl);
  }
...
namespace epmodel {
  namespace detail {
    ...
    bool HeatPumpAirToWater_Impl::setOperatingModeControlSchedule(Schedule& operatingModeControlSchedule) {
      bool result = setSchedule(openstudio::HeatPump_AirToWaterFields::OperatingModeControlScheduleName, "HeatPumpAirToWater",
                                "Operating Mode Control", operatingModeControlSchedule);
      if (result) {
