...
namespace epmodel {
  ...
  CoilHeatingDXVariableSpeed::CoilHeatingDXVariableSpeed(const Model& model, const Curve& partLoadFraction) : CoilHeatingDXVariableSpeed(model) {
  ...
  std::vector<std::string> CoilHeatingDXVariableSpeed::defrostStrategyValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::Coil_Heating_DX_VariableSpeedFields::DefrostStrategy);
  }

  std::vector<std::string> CoilHeatingDXVariableSpeed::defrostControlValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::Coil_Heating_DX_VariableSpeedFields::DefrostControl);
  }
...
namespace epmodel {
  namespace detail {
    ...
    Curve CoilHeatingDXVariableSpeed_Impl::energyPartLoadFractionCurve() const {
      auto value =
        getObject<ModelObject>().getModelObjectTarget<Curve>(openstudio::Coil_Heating_DX_VariableSpeedFields::EnergyPartLoadFractionCurveName);
      OS_ASSERT(value);
      return *value;
    }
    ...
    bool CoilHeatingDXVariableSpeed_Impl::setDefrostEnergyInputRatioFunctionofTemperatureCurve(const Curve& curve) {
      return setPointer(openstudio::Coil_Heating_DX_VariableSpeedFields::DefrostEnergyInputRatioFunctionofTemperatureCurveName, curve.handle(),
                        false);
    }
    ...
    bool CoilHeatingDXVariableSpeed_Impl::setCrankcaseHeaterCapacityFunctionofTemperatureCurve(const Curve& curve) {
      return setPointer(openstudio::Coil_Heating_DX_VariableSpeedFields::CrankcaseHeaterCapacityFunctionofTemperatureCurveName, curve.handle(),
                        false);
    }
