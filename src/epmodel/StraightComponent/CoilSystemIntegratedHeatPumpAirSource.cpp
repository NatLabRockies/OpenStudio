...
namespace epmodel {
  namespace detail {
    ...
    bool CoilSystemIntegratedHeatPumpAirSource_Impl::setIndoorTemperatureLimitForSCWHMode(double indoorTemperatureLimitForSCWHMode) {
      const bool result =
        setDouble(openstudio::CoilSystem_IntegratedHeatPump_AirSourceFields::IndoorTemperatureLimitforSCWHMode, indoorTemperatureLimitForSCWHMode);
      OS_ASSERT(result);
      return result;
    }
    ...
    double CoilSystemIntegratedHeatPumpAirSource_Impl::indoorTemperatureAboveWhichWHHasHigherPriority() const {
      const auto value = getDouble(openstudio::CoilSystem_IntegratedHeatPump_AirSourceFields::IndoorTemperatureaboveWhichWHhasHigherPriority, true);
      OS_ASSERT(value);
      return *value;
    }
    ...
    double CoilSystemIntegratedHeatPumpAirSource_Impl::ambientTemperatureAboveWhichWHHasHigherPriority() const {
      const auto value = getDouble(openstudio::CoilSystem_IntegratedHeatPump_AirSourceFields::AmbientTemperatureaboveWhichWHhasHigherPriority, true);
      OS_ASSERT(value);
      return *value;
    }
    ...
    bool CoilSystemIntegratedHeatPumpAirSource_Impl::setAmbientTemperatureAboveWhichWHHasHigherPriority(
      double ambientTemperatureAboveWhichWHHasHigherPriority) {
      const bool result = setDouble(openstudio::CoilSystem_IntegratedHeatPump_AirSourceFields::AmbientTemperatureaboveWhichWHhasHigherPriority,
                                    ambientTemperatureAboveWhichWHHasHigherPriority);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool CoilSystemIntegratedHeatPumpAirSource_Impl::setMaximumRunningTimeBeforeAllowingElectricResistanceHeatUseDuringSHDWHMode(
      double maximumRunningTimeBeforeAllowingElectricResistanceHeatUseDuringSHDWHMode) {
      const bool result =
        setDouble(openstudio::CoilSystem_IntegratedHeatPump_AirSourceFields::MaximumRunningTimebeforeAllowingElectricResistanceHeatUseduringSHDWHMode,
                  maximumRunningTimeBeforeAllowingElectricResistanceHeatUseDuringSHDWHMode);
      OS_ASSERT(result);
      return result;
    }
    ...
    boost::optional<HVACComponent> CoilSystemIntegratedHeatPumpAirSource_Impl::optionalScwhCoil() const {
      return getObject<ModelObject>().getModelObjectTarget<HVACComponent>(openstudio::CoilSystem_IntegratedHeatPump_AirSourceFields::SCWHCoilName);
    }
    ...
    bool CoilSystemIntegratedHeatPumpAirSource_Impl::setDedicatedWaterHeatingCoil(const HVACComponent& dedicatedWaterHeatingCoil) {
      return setPointer(openstudio::CoilSystem_IntegratedHeatPump_AirSourceFields::DedicatedWaterHeatingCoilName, dedicatedWaterHeatingCoil.handle(),
                        false);
    }
