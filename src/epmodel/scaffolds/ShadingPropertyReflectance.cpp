...
ShadingPropertyReflectance::ShadingPropertyReflectance(std::shared_ptr<detail::ShadingPropertyReflectance_Impl> impl) : ModelObject(std::move(impl)) {}
...
bool ShadingPropertyReflectance::setDiffuseSolarReflectanceofUnglazedPartofShadingSurface(
  ...
  return getImpl<detail::ShadingPropertyReflectance_Impl>()
    ->setDiffuseSolarReflectanceofUnglazedPartofShadingSurface(diffuseSolarReflectanceofUnglazedPartofShadingSurface);
}
...
bool ShadingPropertyReflectance::setDiffuseVisibleReflectanceofUnglazedPartofShadingSurface(
  ...
  return getImpl<detail::ShadingPropertyReflectance_Impl>()
    ->setDiffuseVisibleReflectanceofUnglazedPartofShadingSurface(diffuseVisibleReflectanceofUnglazedPartofShadingSurface);
}
