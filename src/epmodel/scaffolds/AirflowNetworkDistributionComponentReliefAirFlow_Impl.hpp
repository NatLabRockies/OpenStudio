...
#ifndef EPMODEL_AIRFLOWNETWORKDISTRIBUTIONCOMPONENTRELIEFAIRFLOW_IMPL_HPP
#define EPMODEL_AIRFLOWNETWORKDISTRIBUTIONCOMPONENTRELIEFAIRFLOW_IMPL_HPP
...
namespace epmodel {
  ...
  namespace detail {
    ...
    class EPMODEL_API AirflowNetworkDistributionComponentReliefAirFlow_Impl : public ModelObject_Impl
    {
     public:
      using ModelObject_Impl::ModelObject_Impl;
      virtual ~AirflowNetworkDistributionComponentReliefAirFlow_Impl() override = default;
