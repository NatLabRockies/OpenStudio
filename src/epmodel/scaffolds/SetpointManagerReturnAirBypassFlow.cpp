...
namespace epmodel {
  ...
  SetpointManagerReturnAirBypassFlow::SetpointManagerReturnAirBypassFlow(std::shared_ptr<detail::SetpointManagerReturnAirBypassFlow_Impl> impl)
  ...
  std::vector<std::string> SetpointManagerReturnAirBypassFlow::controlVariableValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(),
                          openstudio::SetpointManager_ReturnAirBypassFlowFields::ControlVariable);
  }
