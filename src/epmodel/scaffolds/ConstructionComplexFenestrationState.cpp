...
ConstructionComplexFenestrationState::ConstructionComplexFenestrationState(
  std::shared_ptr<detail::ConstructionComplexFenestrationState_Impl> impl)
...
std::vector<std::string> ConstructionComplexFenestrationState::basisTypeValues() {
  return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::Construction_ComplexFenestrationStateFields::BasisType);
}
