...
namespace epmodel {
  ...
  SizingPeriodWeatherFileConditionType::SizingPeriodWeatherFileConditionType(std::shared_ptr<detail::SizingPeriodWeatherFileConditionType_Impl> impl)
  ...
  bool SizingPeriodWeatherFileConditionType::setUseWeatherFileDaylightSavingPeriod(bool useWeatherFileDaylightSavingPeriod) {
    return getImpl<detail::SizingPeriodWeatherFileConditionType_Impl>()->setUseWeatherFileDaylightSavingPeriod(useWeatherFileDaylightSavingPeriod);
  }
  ...
  bool SizingPeriodWeatherFileConditionType::setUseWeatherFileRainandSnowIndicators(bool useWeatherFileRainandSnowIndicators) {
    return getImpl<detail::SizingPeriodWeatherFileConditionType_Impl>()->setUseWeatherFileRainandSnowIndicators(useWeatherFileRainandSnowIndicators);
  }
