...
namespace epmodel {
  ...
  OutputMeterMeterFileOnly::OutputMeterMeterFileOnly(const Model& model) : ModelObject(OutputMeterMeterFileOnly::iddObjectType(), model) {}

  OutputMeterMeterFileOnly::OutputMeterMeterFileOnly(std::shared_ptr<detail::OutputMeterMeterFileOnly_Impl> impl) : ModelObject(std::move(impl)) {}
  ...
  std::vector<std::string> OutputMeterMeterFileOnly::reportingFrequencyValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), openstudio::Output_Meter_MeterFileOnlyFields::ReportingFrequency);
  }
