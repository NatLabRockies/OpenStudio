...
bool SetpointManagerReturnTemperatureChilledWater::setMinimumSupplyTemperatureSetpoint(double minimumSupplyTemperatureSetpoint) {
  return getImpl<detail::SetpointManagerReturnTemperatureChilledWater_Impl>()->setMinimumSupplyTemperatureSetpoint(minimumSupplyTemperatureSetpoint);
}
...
bool SetpointManagerReturnTemperatureChilledWater::setMaximumSupplyTemperatureSetpoint(double maximumSupplyTemperatureSetpoint) {
  return getImpl<detail::SetpointManagerReturnTemperatureChilledWater_Impl>()->setMaximumSupplyTemperatureSetpoint(maximumSupplyTemperatureSetpoint);
}
...
bool SetpointManagerReturnTemperatureChilledWater::setReturnTemperatureSetpointInputType(const std::string& returnTemperatureSetpointInputType) {
  return getImpl<detail::SetpointManagerReturnTemperatureChilledWater_Impl>()->setReturnTemperatureSetpointInputType(returnTemperatureSetpointInputType);
}
...
bool SetpointManagerReturnTemperatureChilledWater::setReturnTemperatureSetpointConstantValue(double returnTemperatureSetpointConstantValue) {
  return getImpl<detail::SetpointManagerReturnTemperatureChilledWater_Impl>()->setReturnTemperatureSetpointConstantValue(returnTemperatureSetpointConstantValue);
}
...
bool SetpointManagerReturnTemperatureChilledWater_Impl::setMinimumSupplyTemperatureSetpoint(double minimumSupplyTemperatureSetpoint) {
  const bool result =
    setDouble(openstudio::SetpointManager_ReturnTemperature_ChilledWaterFields::MinimumSupplyTemperatureSetpoint, minimumSupplyTemperatureSetpoint);
  OS_ASSERT(result);
  return result;
}
...
bool SetpointManagerReturnTemperatureChilledWater_Impl::setMaximumSupplyTemperatureSetpoint(double maximumSupplyTemperatureSetpoint) {
  const bool result =
    setDouble(openstudio::SetpointManager_ReturnTemperature_ChilledWaterFields::MaximumSupplyTemperatureSetpoint, maximumSupplyTemperatureSetpoint);
  OS_ASSERT(result);
  return result;
}
...
bool SetpointManagerReturnTemperatureChilledWater_Impl::setReturnTemperatureSetpointInputType(const std::string& returnTemperatureSetpointInputType) {
