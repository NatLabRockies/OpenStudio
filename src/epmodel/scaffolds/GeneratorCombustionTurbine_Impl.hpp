...
#ifndef EPMODEL_GENERATORCOMBUSTIONTURBINE_IMPL_HPP
#define EPMODEL_GENERATORCOMBUSTIONTURBINE_IMPL_HPP
...
namespace epmodel {
  ...
  namespace detail {
    ...
    class EPMODEL_API GeneratorCombustionTurbine_Impl : public ModelObject_Impl
    {
     public:
      using ModelObject_Impl::ModelObject_Impl;
      virtual ~GeneratorCombustionTurbine_Impl() override = default;
