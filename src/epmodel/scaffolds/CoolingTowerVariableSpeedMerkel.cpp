...
std::vector<std::string> CoolingTowerVariableSpeedMerkel::cellControlValues() {
  return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(),
                        openstudio::CoolingTower_VariableSpeed_MerkelFields::CellControl);
}
...
bool CoolingTowerVariableSpeedMerkel::setHeatRejectionCapacityandNominalCapacitySizingRatio(
  ...
  return getImpl<detail::CoolingTowerVariableSpeedMerkel_Impl>()
    ->setHeatRejectionCapacityandNominalCapacitySizingRatio(heatRejectionCapacityandNominalCapacitySizingRatio);
}
...
bool CoolingTowerVariableSpeedMerkel::setDesignFanPowerPerUnitofNominalCapacity(double designFanPowerPerUnitofNominalCapacity) {
  return getImpl<detail::CoolingTowerVariableSpeedMerkel_Impl>()->setDesignFanPowerPerUnitofNominalCapacity(
...
bool CoolingTowerVariableSpeedMerkel::setDesignAirFlowRateUFactorTimesAreaValue(double designAirFlowRateUFactorTimesAreaValue) {
  return getImpl<detail::CoolingTowerVariableSpeedMerkel_Impl>()->setDesignAirFlowRateUFactorTimesAreaValue(
...
bool CoolingTowerVariableSpeedMerkel_Impl::setFreeConvectionUFactorTimesAreaValueSizingFactor(double freeConvectionUFactorTimesAreaValueSizingFactor) {
