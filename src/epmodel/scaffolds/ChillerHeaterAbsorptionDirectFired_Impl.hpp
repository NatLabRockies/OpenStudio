...
#ifndef EPMODEL_CHILLERHEATERABSORPTIONDIRECTFIRED_IMPL_HPP
#define EPMODEL_CHILLERHEATERABSORPTIONDIRECTFIRED_IMPL_HPP
...
namespace epmodel {
  ...
  namespace detail {
    ...
    class EPMODEL_API ChillerHeaterAbsorptionDirectFired_Impl : public ModelObject_Impl
    {
     public:
      using ModelObject_Impl::ModelObject_Impl;
      virtual ~ChillerHeaterAbsorptionDirectFired_Impl() override = default;
