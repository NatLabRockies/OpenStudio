...
namespace epmodel {
  ...
  bool DesignSpecificationAirTerminalSizing::setCoolingDesignSupplyAirTemperatureDifferenceRatio(
  ...
  bool DesignSpecificationAirTerminalSizing::setHeatingDesignSupplyAirTemperatureDifferenceRatio(
