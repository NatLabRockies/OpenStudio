...
#ifndef EPMODEL_ZONEHVACBASEBOARDRADIANTCONVECTIVESTEAMDESIGN_IMPL_HPP
#define EPMODEL_ZONEHVACBASEBOARDRADIANTCONVECTIVESTEAMDESIGN_IMPL_HPP
...
namespace epmodel {
  ...
  namespace detail {
    ...
    class EPMODEL_API ZoneHVACBaseboardRadiantConvectiveSteamDesign_Impl : public ModelObject_Impl
    {
     public:
      using ModelObject_Impl::ModelObject_Impl;
      virtual ~ZoneHVACBaseboardRadiantConvectiveSteamDesign_Impl() override = default;
