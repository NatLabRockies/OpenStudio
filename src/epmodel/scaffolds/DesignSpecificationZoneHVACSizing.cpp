...
namespace epmodel {
  ...
  bool DesignSpecificationZoneHVACSizing::setCoolingFractionofAutosizedCoolingSupplyAirFlowRate(
  ...
  bool DesignSpecificationZoneHVACSizing::setNoLoadFractionofCoolingSupplyAirFlowRate(double noLoadFractionofCoolingSupplyAirFlowRate) {
    return getImpl<detail::DesignSpecificationZoneHVACSizing_Impl>()->setNoLoadFractionofCoolingSupplyAirFlowRate(
  ...
  bool DesignSpecificationZoneHVACSizing::setNoLoadFractionofHeatingSupplyAirFlowRate(double noLoadFractionofHeatingSupplyAirFlowRate) {
    return getImpl<detail::DesignSpecificationZoneHVACSizing_Impl>()->setNoLoadFractionofHeatingSupplyAirFlowRate(
  ...
  bool DesignSpecificationZoneHVACSizing::setHeatingFractionofHeatingSupplyAirFlowRate(double heatingFractionofHeatingSupplyAirFlowRate) {
    return getImpl<detail::DesignSpecificationZoneHVACSizing_Impl>()->setHeatingFractionofHeatingSupplyAirFlowRate(
...
namespace epmodel {
  namespace detail {
    ...
    bool DesignSpecificationZoneHVACSizing_Impl::setCoolingSupplyAirFlowRatePerUnitCoolingCapacity(
      double coolingSupplyAirFlowRatePerUnitCoolingCapacity) {
