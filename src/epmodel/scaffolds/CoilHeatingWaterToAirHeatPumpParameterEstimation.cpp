...
namespace epmodel {
  ...
  bool
    CoilHeatingWaterToAirHeatPumpParameterEstimation::setSuperheatTemperatureattheEvaporatorOutlet(double superheatTemperatureattheEvaporatorOutlet) {
...
namespace epmodel {
  namespace detail {
    ...
    bool CoilHeatingWaterToAirHeatPumpParameterEstimation_Impl::setGrossRatedHeatingCapacity(double grossRatedHeatingCapacity) {
      return setDouble(openstudio::Coil_Heating_WaterToAirHeatPump_ParameterEstimationFields::GrossRatedHeatingCapacity, grossRatedHeatingCapacity);
    }
    ...
    double CoilHeatingWaterToAirHeatPumpParameterEstimation_Impl::loadSideTotalHeatTransferCoefficient() const {
      const auto value = getDouble(openstudio::Coil_Heating_WaterToAirHeatPump_ParameterEstimationFields::LoadSideTotalHeatTransferCoefficient, true);
      OS_ASSERT(value);
      return *value;
    }
