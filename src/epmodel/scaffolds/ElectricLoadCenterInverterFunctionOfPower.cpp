...
namespace epmodel {
  ...
  bool ElectricLoadCenterInverterFunctionOfPower::setRatedMaximumContinuousInputPower(double ratedMaximumContinuousInputPower) {
    return getImpl<detail::ElectricLoadCenterInverterFunctionOfPower_Impl>()->setRatedMaximumContinuousInputPower(ratedMaximumContinuousInputPower);
  }
  ...
  bool ElectricLoadCenterInverterFunctionOfPower::setAncillaryPowerConsumedInStandby(double ancillaryPowerConsumedInStandby) {
    return getImpl<detail::ElectricLoadCenterInverterFunctionOfPower_Impl>()->setAncillaryPowerConsumedInStandby(ancillaryPowerConsumedInStandby);
  }
