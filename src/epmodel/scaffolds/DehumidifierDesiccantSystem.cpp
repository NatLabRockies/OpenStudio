...
namespace epmodel {
  ...
  DehumidifierDesiccantSystem::DehumidifierDesiccantSystem(const Model& model) : ModelObject(DehumidifierDesiccantSystem::iddObjectType(), model) {}
...
namespace epmodel {
  namespace detail {
    ...
    bool DehumidifierDesiccantSystem_Impl::setRegenerationInletAirSetpointTemperature(double regenerationInletAirSetpointTemperature) {
      return setDouble(openstudio::Dehumidifier_Desiccant_SystemFields::RegenerationInletAirSetpointTemperature,
    ...
    bool DehumidifierDesiccantSystem_Impl::setCompanionCoolingCoilUpstreamofDehumidifierProcessInlet(
      bool companionCoolingCoilUpstreamofDehumidifierProcessInlet) {
      const bool result =
        setBooleanFieldValue(*this, openstudio::Dehumidifier_Desiccant_SystemFields::CompanionCoolingCoilUpstreamofDehumidifierProcessInlet,
                             companionCoolingCoilUpstreamofDehumidifierProcessInlet);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool DehumidifierDesiccantSystem_Impl::setCompanionCoilRegenerationAirHeating(bool companionCoilRegenerationAirHeating) {
      const bool result = setBooleanFieldValue(*this, openstudio::Dehumidifier_Desiccant_SystemFields::CompanionCoilRegenerationAirHeating,
