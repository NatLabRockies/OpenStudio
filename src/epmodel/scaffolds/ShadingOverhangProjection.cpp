...
namespace epmodel {
  ...
  ShadingOverhangProjection::ShadingOverhangProjection(std::shared_ptr<detail::ShadingOverhangProjection_Impl> impl) : ModelObject(std::move(impl)) {}
...
namespace epmodel {
  namespace detail {
    ...
    bool ShadingOverhangProjection_Impl::setLeftextensionfromWindowDoorWidth(double leftextensionfromWindowDoorWidth) {
      const bool result =
        setDouble(openstudio::Shading_Overhang_ProjectionFields::LeftextensionfromWindow_DoorWidth, leftextensionfromWindowDoorWidth);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool ShadingOverhangProjection_Impl::setRightextensionfromWindowDoorWidth(double rightextensionfromWindowDoorWidth) {
      const bool result =
        setDouble(openstudio::Shading_Overhang_ProjectionFields::RightextensionfromWindow_DoorWidth, rightextensionfromWindowDoorWidth);
      OS_ASSERT(result);
      return result;
    }
