...
#ifndef EPMODEL_CHILLERENGINEDRIVEN_IMPL_HPP
#define EPMODEL_CHILLERENGINEDRIVEN_IMPL_HPP
...
class EPMODEL_API ChillerEngineDriven_Impl : public ModelObject_Impl
{
 public:
  using ModelObject_Impl::ModelObject_Impl;
  virtual ~ChillerEngineDriven_Impl() override = default;
