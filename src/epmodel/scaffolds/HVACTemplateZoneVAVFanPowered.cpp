...
namespace epmodel {
  namespace detail {
    ...
    bool HVACTemplateZoneVAVFanPowered_Impl::setPrimarySupplyAirMaximumFlowRate(double primarySupplyAirMaximumFlowRate) {
      const bool result =
        setDouble(openstudio::HVACTemplate_Zone_VAV_FanPoweredFields::PrimarySupplyAirMaximumFlowRate, primarySupplyAirMaximumFlowRate);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool HVACTemplateZoneVAVFanPowered_Impl::setSecondarySupplyAirMaximumFlowRate(double secondarySupplyAirMaximumFlowRate) {
      const bool result =
        setDouble(openstudio::HVACTemplate_Zone_VAV_FanPoweredFields::SecondarySupplyAirMaximumFlowRate, secondarySupplyAirMaximumFlowRate);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool HVACTemplateZoneVAVFanPowered_Impl::setZoneCoolingDesignSupplyAirTemperature(double zoneCoolingDesignSupplyAirTemperature) {
      const bool result =
        setDouble(openstudio::HVACTemplate_Zone_VAV_FanPoweredFields::ZoneCoolingDesignSupplyAirTemperature, zoneCoolingDesignSupplyAirTemperature);
      OS_ASSERT(result);
      return result;
    }

    bool
      HVACTemplateZoneVAVFanPowered_Impl::setZoneCoolingDesignSupplyAirTemperatureDifference(double zoneCoolingDesignSupplyAirTemperatureDifference) {
    ...
    bool HVACTemplateZoneVAVFanPowered_Impl::setZoneHeatingDesignSupplyAirTemperature(double zoneHeatingDesignSupplyAirTemperature) {
      const bool result =
        setDouble(openstudio::HVACTemplate_Zone_VAV_FanPoweredFields::ZoneHeatingDesignSupplyAirTemperature, zoneHeatingDesignSupplyAirTemperature);
      OS_ASSERT(result);
      return result;
    }

    bool
      HVACTemplateZoneVAVFanPowered_Impl::setZoneHeatingDesignSupplyAirTemperatureDifference(double zoneHeatingDesignSupplyAirTemperatureDifference) {
