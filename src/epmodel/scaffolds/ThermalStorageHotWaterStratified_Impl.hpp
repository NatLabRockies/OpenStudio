...
#ifndef EPMODEL_THERMALSTORAGEHOTWATERSTRATIFIED_IMPL_HPP
#define EPMODEL_THERMALSTORAGEHOTWATERSTRATIFIED_IMPL_HPP
...
namespace epmodel {
  ...
  namespace detail {
    ...
    class EPMODEL_API ThermalStorageHotWaterStratified_Impl : public ModelObject_Impl
    {
     public:
      using ModelObject_Impl::ModelObject_Impl;
      virtual ~ThermalStorageHotWaterStratified_Impl() override = default;
