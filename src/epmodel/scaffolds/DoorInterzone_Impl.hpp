...
#ifndef EPMODEL_DOORINTERZONE_IMPL_HPP
#define EPMODEL_DOORINTERZONE_IMPL_HPP
...
namespace epmodel {
  ...
  namespace detail {
    ...
    class EPMODEL_API DoorInterzone_Impl : public ModelObject_Impl
    {
     public:
      using ModelObject_Impl::ModelObject_Impl;
      virtual ~DoorInterzone_Impl() override = default;
