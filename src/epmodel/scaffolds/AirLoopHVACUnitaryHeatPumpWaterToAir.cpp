...
AirLoopHVACUnitaryHeatPumpWaterToAir::AirLoopHVACUnitaryHeatPumpWaterToAir(
  std::shared_ptr<detail::AirLoopHVACUnitaryHeatPumpWaterToAir_Impl> impl)
...
bool AirLoopHVACUnitaryHeatPumpWaterToAir_Impl::setSupplementalHeatingCoilObjectType(const std::string& supplementalHeatingCoilObjectType) {
  return setString(openstudio::AirLoopHVAC_UnitaryHeatPump_WaterToAirFields::SupplementalHeatingCoilObjectType, supplementalHeatingCoilObjectType);
}
...
double AirLoopHVACUnitaryHeatPumpWaterToAir_Impl::maximumOutdoorDryBulbTemperatureforSupplementalHeaterOperation() const {
  const auto value = getDouble(openstudio::AirLoopHVAC_UnitaryHeatPump_WaterToAirFields::MaximumOutdoorDryBulbTemperatureforSupplementalHeaterOperation,
                               true);
  OS_ASSERT(value);
  return *value;
}
...
void AirLoopHVACUnitaryHeatPumpWaterToAir_Impl::resetMaximumOutdoorDryBulbTemperatureforSupplementalHeaterOperation() {
  OS_ASSERT(setString(openstudio::AirLoopHVAC_UnitaryHeatPump_WaterToAirFields::MaximumOutdoorDryBulbTemperatureforSupplementalHeaterOperation,
                      ""));
}
