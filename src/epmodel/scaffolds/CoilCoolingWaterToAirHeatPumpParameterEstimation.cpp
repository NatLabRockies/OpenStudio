...
bool CoilCoolingWaterToAirHeatPumpParameterEstimation::setSuperheatTemperatureattheEvaporatorOutlet(
...
bool CoilCoolingWaterToAirHeatPumpParameterEstimation_Impl::setNominalCoolingCoilCapacity(double nominalCoolingCoilCapacity) {
  return setDouble(openstudio::Coil_Cooling_WaterToAirHeatPump_ParameterEstimationFields::NominalCoolingCoilCapacity,
...
double CoilCoolingWaterToAirHeatPumpParameterEstimation_Impl::loadSideTotalHeatTransferCoefficient() const {
  const auto value =
    getDouble(openstudio::Coil_Cooling_WaterToAirHeatPump_ParameterEstimationFields::LoadSideTotalHeatTransferCoefficient, true);
  OS_ASSERT(value);
  return *value;
}

bool CoilCoolingWaterToAirHeatPumpParameterEstimation_Impl::setLoadSideTotalHeatTransferCoefficient(
  double loadSideTotalHeatTransferCoefficient) {
...
double CoilCoolingWaterToAirHeatPumpParameterEstimation_Impl::loadSideOutsideSurfaceHeatTransferCoefficient() const {
  const auto value = getDouble(openstudio::Coil_Cooling_WaterToAirHeatPump_ParameterEstimationFields::LoadSideOutsideSurfaceHeatTransferCoefficient,
                               true);
  OS_ASSERT(value);
  return *value;
}
...
bool CoilCoolingWaterToAirHeatPumpParameterEstimation_Impl::setLatentCapacityTimeConstant(double latentCapacityTimeConstant) {
  return setDouble(openstudio::Coil_Cooling_WaterToAirHeatPump_ParameterEstimationFields::LatentCapacityTimeConstant,
