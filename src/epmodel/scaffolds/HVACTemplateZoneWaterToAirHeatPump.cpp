...
namespace epmodel {
  ...
  HVACTemplateZoneWaterToAirHeatPump::HVACTemplateZoneWaterToAirHeatPump(const Model& model)
    : ModelObject(HVACTemplateZoneWaterToAirHeatPump::iddObjectType(), model) {}

  HVACTemplateZoneWaterToAirHeatPump::HVACTemplateZoneWaterToAirHeatPump(std::shared_ptr<detail::HVACTemplateZoneWaterToAirHeatPump_Impl> impl)
  ...
  bool HVACTemplateZoneWaterToAirHeatPump::setCoolingCoilGrossRatedSensibleHeatRatio(double coolingCoilGrossRatedSensibleHeatRatio) {
    return getImpl<detail::HVACTemplateZoneWaterToAirHeatPump_Impl>()->setCoolingCoilGrossRatedSensibleHeatRatio(
  ...
  bool HVACTemplateZoneWaterToAirHeatPump::setHeatPumpHeatingCoilGrossRatedCapacity(double heatPumpHeatingCoilGrossRatedCapacity) {
    return getImpl<detail::HVACTemplateZoneWaterToAirHeatPump_Impl>()->setHeatPumpHeatingCoilGrossRatedCapacity(
  ...
  bool HVACTemplateZoneWaterToAirHeatPump::setZoneCoolingDesignSupplyAirTemperatureInputMethod(
    const std::string& zoneCoolingDesignSupplyAirTemperatureInputMethod) {
    return getImpl<detail::HVACTemplateZoneWaterToAirHeatPump_Impl>()->setZoneCoolingDesignSupplyAirTemperatureInputMethod(
  ...
  bool HVACTemplateZoneWaterToAirHeatPump::setZoneCoolingDesignSupplyAirTemperature(double zoneCoolingDesignSupplyAirTemperature) {
    return getImpl<detail::HVACTemplateZoneWaterToAirHeatPump_Impl>()->setZoneCoolingDesignSupplyAirTemperature(
  ...
  bool
    HVACTemplateZoneWaterToAirHeatPump::setZoneCoolingDesignSupplyAirTemperatureDifference(double zoneCoolingDesignSupplyAirTemperatureDifference) {
    return getImpl<detail::HVACTemplateZoneWaterToAirHeatPump_Impl>()->setZoneCoolingDesignSupplyAirTemperatureDifference(
  ...
  bool HVACTemplateZoneWaterToAirHeatPump::setZoneHeatingDesignSupplyAirTemperatureInputMethod(
    const std::string& zoneHeatingDesignSupplyAirTemperatureInputMethod) {
    return getImpl<detail::HVACTemplateZoneWaterToAirHeatPump_Impl>()->setZoneHeatingDesignSupplyAirTemperatureInputMethod(
  ...
  bool HVACTemplateZoneWaterToAirHeatPump::setZoneHeatingDesignSupplyAirTemperature(double zoneHeatingDesignSupplyAirTemperature) {
    return getImpl<detail::HVACTemplateZoneWaterToAirHeatPump_Impl>()->setZoneHeatingDesignSupplyAirTemperature(
  ...
  bool
    HVACTemplateZoneWaterToAirHeatPump::setZoneHeatingDesignSupplyAirTemperatureDifference(double zoneHeatingDesignSupplyAirTemperatureDifference) {
    return getImpl<detail::HVACTemplateZoneWaterToAirHeatPump_Impl>()->setZoneHeatingDesignSupplyAirTemperatureDifference(
...
namespace epmodel {
  namespace detail {
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setOutdoorAirFlowRateperZoneFloorArea(double outdoorAirFlowRateperZoneFloorArea) {
      const bool result =
        setDouble(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::OutdoorAirFlowRateperZoneFloorArea, outdoorAirFlowRateperZoneFloorArea);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setCoolingCoilGrossRatedTotalCapacity(double coolingCoilGrossRatedTotalCapacity) {
      const bool result =
        setDouble(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::CoolingCoilGrossRatedTotalCapacity, coolingCoilGrossRatedTotalCapacity);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setCoolingCoilGrossRatedSensibleHeatRatio(double coolingCoilGrossRatedSensibleHeatRatio) {
      return setDouble(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::CoolingCoilGrossRatedSensibleHeatRatio,
                       coolingCoilGrossRatedSensibleHeatRatio);
    }
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setHeatPumpHeatingCoilGrossRatedCapacity(double heatPumpHeatingCoilGrossRatedCapacity) {
      const bool result = setDouble(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::HeatPumpHeatingCoilGrossRatedCapacity,
                                    heatPumpHeatingCoilGrossRatedCapacity);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setHeatPumpHeatingCoilGrossRatedCOP(double heatPumpHeatingCoilGrossRatedCOP) {
      const bool result =
        setDouble(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::HeatPumpHeatingCoilGrossRatedCOP, heatPumpHeatingCoilGrossRatedCOP);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setSupplementalHeatingCoilCapacity(double supplementalHeatingCoilCapacity) {
      const bool result =
        setDouble(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::SupplementalHeatingCoilCapacity, supplementalHeatingCoilCapacity);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setZoneCoolingDesignSupplyAirTemperatureInputMethod(
      const std::string& zoneCoolingDesignSupplyAirTemperatureInputMethod) {
      return setString(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::ZoneCoolingDesignSupplyAirTemperatureInputMethod,
                       zoneCoolingDesignSupplyAirTemperatureInputMethod);
    }
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setZoneCoolingDesignSupplyAirTemperature(double zoneCoolingDesignSupplyAirTemperature) {
      const bool result = setDouble(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::ZoneCoolingDesignSupplyAirTemperature,
                                    zoneCoolingDesignSupplyAirTemperature);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setZoneCoolingDesignSupplyAirTemperatureDifference(
      double zoneCoolingDesignSupplyAirTemperatureDifference) {
      const bool result = setDouble(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::ZoneCoolingDesignSupplyAirTemperatureDifference,
                                    zoneCoolingDesignSupplyAirTemperatureDifference);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setZoneHeatingDesignSupplyAirTemperatureInputMethod(
      const std::string& zoneHeatingDesignSupplyAirTemperatureInputMethod) {
      return setString(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::ZoneHeatingDesignSupplyAirTemperatureInputMethod,
                       zoneHeatingDesignSupplyAirTemperatureInputMethod);
    }
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setZoneHeatingDesignSupplyAirTemperature(double zoneHeatingDesignSupplyAirTemperature) {
      const bool result = setDouble(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::ZoneHeatingDesignSupplyAirTemperature,
                                    zoneHeatingDesignSupplyAirTemperature);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool HVACTemplateZoneWaterToAirHeatPump_Impl::setZoneHeatingDesignSupplyAirTemperatureDifference(
      double zoneHeatingDesignSupplyAirTemperatureDifference) {
      const bool result = setDouble(openstudio::HVACTemplate_Zone_WaterToAirHeatPumpFields::ZoneHeatingDesignSupplyAirTemperatureDifference,
                                    zoneHeatingDesignSupplyAirTemperatureDifference);
      OS_ASSERT(result);
      return result;
    }
