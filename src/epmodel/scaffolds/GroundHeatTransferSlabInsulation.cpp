...
namespace epmodel {
  ...
  bool GroundHeatTransferSlabInsulation::setDINSWidthofstripofunderslabinsulation(double dINSWidthofstripofunderslabinsulation) {
    return getImpl<detail::GroundHeatTransferSlabInsulation_Impl>()->setDINSWidthofstripofunderslabinsulation(dINSWidthofstripofunderslabinsulation);
  }
  ...
  bool GroundHeatTransferSlabInsulation::setIVINSFlagIsthereverticalinsulation(const std::string& iVINSFlagIsthereverticalinsulation) {
    return getImpl<detail::GroundHeatTransferSlabInsulation_Impl>()->setIVINSFlagIsthereverticalinsulation(iVINSFlagIsthereverticalinsulation);
  }
