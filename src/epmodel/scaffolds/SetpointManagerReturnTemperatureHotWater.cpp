...
namespace epmodel {
  ...
  bool SetpointManagerReturnTemperatureHotWater::setReturnTemperatureSetpointInputType(const std::string& returnTemperatureSetpointInputType) {
    return getImpl<detail::SetpointManagerReturnTemperatureHotWater_Impl>()->setReturnTemperatureSetpointInputType(
  ...
  bool SetpointManagerReturnTemperatureHotWater::setReturnTemperatureSetpointConstantValue(double returnTemperatureSetpointConstantValue) {
    return getImpl<detail::SetpointManagerReturnTemperatureHotWater_Impl>()->setReturnTemperatureSetpointConstantValue(
...
namespace epmodel {
  namespace detail {
    ...
    bool SetpointManagerReturnTemperatureHotWater_Impl::setMinimumSupplyTemperatureSetpoint(double minimumSupplyTemperatureSetpoint) {
      const bool result =
        setDouble(openstudio::SetpointManager_ReturnTemperature_HotWaterFields::MinimumSupplyTemperatureSetpoint, minimumSupplyTemperatureSetpoint);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool SetpointManagerReturnTemperatureHotWater_Impl::setMaximumSupplyTemperatureSetpoint(double maximumSupplyTemperatureSetpoint) {
      const bool result =
        setDouble(openstudio::SetpointManager_ReturnTemperature_HotWaterFields::MaximumSupplyTemperatureSetpoint, maximumSupplyTemperatureSetpoint);
      OS_ASSERT(result);
      return result;
    }
