...
namespace epmodel {
  ...
  EvaporativeCoolerIndirectCelDekPad::EvaporativeCoolerIndirectCelDekPad(std::shared_ptr<detail::EvaporativeCoolerIndirectCelDekPad_Impl> impl)
  ...
  bool EvaporativeCoolerIndirectCelDekPad::setIndirectHeatExchangerEffectiveness(double indirectHeatExchangerEffectiveness) {
    return getImpl<detail::EvaporativeCoolerIndirectCelDekPad_Impl>()->setIndirectHeatExchangerEffectiveness(indirectHeatExchangerEffectiveness);
  }
