...
#ifndef EPMODEL_CEILINGADIABATIC_IMPL_HPP
#define EPMODEL_CEILINGADIABATIC_IMPL_HPP
...
namespace epmodel {
  ...
  namespace detail {
    ...
    class EPMODEL_API CeilingAdiabatic_Impl : public ModelObject_Impl
    {
     public:
      using ModelObject_Impl::ModelObject_Impl;
      virtual ~CeilingAdiabatic_Impl() override = default;
