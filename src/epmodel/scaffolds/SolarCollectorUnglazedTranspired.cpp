...
namespace epmodel {
  ...
  bool SolarCollectorUnglazedTranspired::setDistanceBetweenPerforationsinCollector(double distanceBetweenPerforationsinCollector) {
    return getImpl<detail::SolarCollectorUnglazedTranspired_Impl>()->setDistanceBetweenPerforationsinCollector(
  ...
  bool
    SolarCollectorUnglazedTranspired::setEffectiveCrossSectionAreaofPlenumBehindCollector(double effectiveCrossSectionAreaofPlenumBehindCollector) {
  ...
  bool SolarCollectorUnglazedTranspired::setEffectivenessforPerforationswithRespecttoWind(double effectivenessforPerforationswithRespecttoWind) {
...
namespace epmodel {
  namespace detail {
    ...
    bool SolarCollectorUnglazedTranspired_Impl::setThermalEmissivityofCollectorSurface(double thermalEmissivityofCollectorSurface) {
      return setDouble(openstudio::SolarCollector_UnglazedTranspiredFields::ThermalEmissivityofCollectorSurface, thermalEmissivityofCollectorSurface);
    }
    ...
    bool SolarCollectorUnglazedTranspired_Impl::setSolarAbsorbtivityofCollectorSurface(double solarAbsorbtivityofCollectorSurface) {
      return setDouble(openstudio::SolarCollector_UnglazedTranspiredFields::SolarAbsorbtivityofCollectorSurface, solarAbsorbtivityofCollectorSurface);
    }
    ...
    bool SolarCollectorUnglazedTranspired_Impl::setHeatExchangeEffectivenessCorrelation(const std::string& heatExchangeEffectivenessCorrelation) {
    ...
    double SolarCollectorUnglazedTranspired_Impl::ratioofActualCollectorSurfaceAreatoProjectedSurfaceArea() const {
      const auto value =
        getDouble(openstudio::SolarCollector_UnglazedTranspiredFields::RatioofActualCollectorSurfaceAreatoProjectedSurfaceArea, true);
      OS_ASSERT(value);
      return *value;
    }
    ...
    bool
      SolarCollectorUnglazedTranspired_Impl::setEffectivenessforPerforationswithRespecttoWind(double effectivenessforPerforationswithRespecttoWind) {
