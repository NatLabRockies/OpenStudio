...
namespace epmodel {
  ...
  ChillerHeaterAbsorptionDirectFired::ChillerHeaterAbsorptionDirectFired(const Model& model)
    : ModelObject(ChillerHeaterAbsorptionDirectFired::iddObjectType(), model) {}

  ChillerHeaterAbsorptionDirectFired::ChillerHeaterAbsorptionDirectFired(std::shared_ptr<detail::ChillerHeaterAbsorptionDirectFired_Impl> impl)
  ...
  std::vector<std::string> ChillerHeaterAbsorptionDirectFired::temperatureCurveInputVariableValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(),
                          openstudio::ChillerHeater_Absorption_DirectFiredFields::TemperatureCurveInputVariable);
  }

  std::vector<std::string> ChillerHeaterAbsorptionDirectFired::condenserTypeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(),
                          openstudio::ChillerHeater_Absorption_DirectFiredFields::CondenserType);
  }
  ...
  bool ChillerHeaterAbsorptionDirectFired::setDesignEnteringCondenserWaterTemperature(double designEnteringCondenserWaterTemperature) {
    return getImpl<detail::ChillerHeaterAbsorptionDirectFired_Impl>()->setDesignEnteringCondenserWaterTemperature(
...
namespace epmodel {
  namespace detail {
    ...
    bool ChillerHeaterAbsorptionDirectFired_Impl::setHeatingtoCoolingCapacityRatio(double heatingtoCoolingCapacityRatio) {
      const bool result =
        setDouble(openstudio::ChillerHeater_Absorption_DirectFiredFields::HeatingtoCoolingCapacityRatio, heatingtoCoolingCapacityRatio);
      return result;
    }
    ...
    bool ChillerHeaterAbsorptionDirectFired_Impl::setFuelInputtoCoolingOutputRatio(double fuelInputtoCoolingOutputRatio) {
      const bool result =
        setDouble(openstudio::ChillerHeater_Absorption_DirectFiredFields::FuelInputtoCoolingOutputRatio, fuelInputtoCoolingOutputRatio);
      return result;
    }
    ...
    bool ChillerHeaterAbsorptionDirectFired_Impl::setFuelInputtoHeatingOutputRatio(double fuelInputtoHeatingOutputRatio) {
      const bool result =
        setDouble(openstudio::ChillerHeater_Absorption_DirectFiredFields::FuelInputtoHeatingOutputRatio, fuelInputtoHeatingOutputRatio);
      return result;
    }
    ...
    bool ChillerHeaterAbsorptionDirectFired_Impl::setElectricInputtoCoolingOutputRatio(double electricInputtoCoolingOutputRatio) {
      const bool result =
        setDouble(openstudio::ChillerHeater_Absorption_DirectFiredFields::ElectricInputtoCoolingOutputRatio, electricInputtoCoolingOutputRatio);
      return result;
    }
    ...
    bool ChillerHeaterAbsorptionDirectFired_Impl::setElectricInputtoHeatingOutputRatio(double electricInputtoHeatingOutputRatio) {
      const bool result =
        setDouble(openstudio::ChillerHeater_Absorption_DirectFiredFields::ElectricInputtoHeatingOutputRatio, electricInputtoHeatingOutputRatio);
      return result;
    }
    ...
    bool ChillerHeaterAbsorptionDirectFired_Impl::setDesignEnteringCondenserWaterTemperature(double designEnteringCondenserWaterTemperature) {
      const bool result = setDouble(openstudio::ChillerHeater_Absorption_DirectFiredFields::DesignEnteringCondenserWaterTemperature,
                                    designEnteringCondenserWaterTemperature);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool ChillerHeaterAbsorptionDirectFired_Impl::setDesignLeavingChilledWaterTemperature(double designLeavingChilledWaterTemperature) {
      const bool result =
        setDouble(openstudio::ChillerHeater_Absorption_DirectFiredFields::DesignLeavingChilledWaterTemperature, designLeavingChilledWaterTemperature);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool ChillerHeaterAbsorptionDirectFired_Impl::setDesignCondenserWaterFlowRate(double designCondenserWaterFlowRate) {
      const bool result =
        setDouble(openstudio::ChillerHeater_Absorption_DirectFiredFields::DesignCondenserWaterFlowRate, designCondenserWaterFlowRate);
      OS_ASSERT(result);
      return result;
    }
    ...
    bool ChillerHeaterAbsorptionDirectFired_Impl::setTemperatureCurveInputVariable(const std::string& temperatureCurveInputVariable) {
      const bool result =
        setString(openstudio::ChillerHeater_Absorption_DirectFiredFields::TemperatureCurveInputVariable, temperatureCurveInputVariable);
      return result;
    }
    ...
    bool ChillerHeaterAbsorptionDirectFired_Impl::setChilledWaterTemperatureLowerLimit(double chilledWaterTemperatureLowerLimit) {
      const bool result =
        setDouble(openstudio::ChillerHeater_Absorption_DirectFiredFields::ChilledWaterTemperatureLowerLimit, chilledWaterTemperatureLowerLimit);
      OS_ASSERT(result);
      return result;
    }
