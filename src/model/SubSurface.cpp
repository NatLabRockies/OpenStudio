  ...
  namespace detail {
    ...
    const std::vector<std::string>& SubSurface_Impl::outputVariableNames() const {
      static const std::vector<std::string> result{
        ...
        // Conduction and heat storage (applicable to opaque doors)
        ...
        // Window-specific: heat transfer, transmitted/absorbed solar, glazing, frame, divider, blind, screen, shading device
        ...
        "Surface Window Total Absorbed Shortwave Radiation Rate Layer 1",
        ...
        "Surface Window Front Face Temperature Layer 1",
        "Surface Window Back Face Temperature Layer 1",
